...
var __decorate =
    ...
    function (e, t, i, n) {
        ...
        else for (var s = e.length - 1; s >= 0; s--) (o = e[s]) && (a = (r < 3 ? o(a) : r > 3 ? o(t, i, a) : o(t, i)) || a);
    ...
    __spreadArrays =
        ...
        function () {
            ...
            for (var n = Array(e), o = 0, t = 0; t < i; t++) for (var r = arguments[t], a = 0, s = r.length; a < s; a++, o++) n[o] = r[a];
            return n;
        },
    QdbdApp;
!(function (e) {
    function t(e, t, i, n, o, r, a, s) {
        function c() {
        ...
        a.buildVersion && console.log && console.log(a.buildVersion),
            ...
            s.setPrefix("QdbdApp"),
            t
                .state("root", { abstract: !0, views: { header: { template: "<dt-header></dt-header>" }, layout: {} } })
                .state("root.standard", { abstract: !0, views: { "layout@": { templateUrl: "cache/common/layouts/standard.html" } } })
                .state("root.standardPadded", { abstract: !0, views: { "layout@": { templateUrl: "cache/common/layouts/standard-padded.html" } } })
                .state("root.standardShrinkable", { abstract: !0, views: { "layout@": { templateUrl: "cache/common/layouts/standard-shrinkable.html" } } })
                .state("root.centered", { abstract: !0, views: { "layout@": { templateUrl: "cache/common/layouts/centered.html" } } }),
            n.deferIntercept(),
            n.otherwise("/"),
           
           
            o.definePalette("qdbdPalette", {
                50: "#b6c1cb",
                100: "#8a9aab",
                200: "#697e93",
                300: "#4b5b6a",
            ...
            o.theme("default").primaryPalette("qdbdPalette"),
            o.theme("warning"),
            o.theme("error");
    }
    function i(e, t, i, n) {
        ...
        i.resolveCurrentUser().then(o, o),
            t.addEventListener("load", function () {
                t.cookieconsent &&
                    t.cookieconsent.initialise({
                        palette: { popup: { background: "#282d32", text: "#c9cccf" }, button: { background: "#1e5ba2" } },
                        position: "bottom-left",
                        content: { href: "https://www.quickdatabasediagrams.com/privacy-and-security.html" },
                        cookie: { domain: n.webApp.cookieConsentDomain },
                    });
            });
    }
...
!(function (e) {
    e.Component = function (e, t, i) {
        return function (n) {
            ("string" == typeof e ? angular.module(e) : e).component(t, angular.extend(i, { controller: n }));
        };
    };
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
...
QdbdApp || (QdbdApp = {}),
    angular.module("QdbdApp.Admin", []).config([
        "$stateProvider",
        function (e) {
            e.state("root.standard.admin", { url: "/admin", views: { "main-content": { templateUrl: "cache/modules/admin/admin.html" }, "context-menu@root": { template: "Administration" } } })
                .state("root.standard.admin.userList", {
                    url: "/users?page&pageSize&sortBy&search&sortOperator",
                    views: { "admin-content": { template: "<dt-user-list filter='AdminVM.usersFilter'></dt-user-list>" } },
                    data: { title: "Administration - Users" },
                    params: { page: { dynamic: !0 }, pageSize: { dynamic: !0 }, sortBy: { dynamic: !0 }, search: { dynamic: !0 }, sortOperator: { dynamic: !0 } },
                })
                .state("root.standard.admin.diagramList", {
                    url: "/schemas?page&pageSize&sortBy&search&sortOperator",
                    views: { "admin-content": { template: "<dt-schema-list filter='AdminVM.schemasFilter'></dt-schema-list>" } },
                    data: { title: "Administration - Schemas" },
                    params: { page: { dynamic: !0 }, pageSize: { dynamic: !0 }, sortBy: { dynamic: !0 }, search: { dynamic: !0 }, sortOperator: { dynamic: !0 } },
                })
                .state("root.standard.admin.vouchersList", {
                    url: "/vouchers?page&pageSize&sortBy&search&sortOperator",
                    views: { "admin-content": { template: "<dt-voucher-list filter='AdminVM.voucherFilter'></dt-voucher-list>" } },
                    data: { title: "Administration - Voucher" },
                    params: { page: { dynamic: !0 }, pageSize: { dynamic: !0 }, sortBy: { dynamic: !0 }, search: { dynamic: !0 }, sortOperator: { dynamic: !0 } },
                })
                .state("root.standard.admin.voucher", { url: "/voucher", views: { "admin-content": { templateUrl: "cache/modules/voucher/voucher.html" } }, data: { title: "Administration - Voucher" }, params: { voucher: null } });
        },
    ]);
var QdbdApp;
...
var QdbdApp;
QdbdApp || (QdbdApp = {}),
    angular.module("QdbdApp.Home", ["QdbdApp.SourceEditor", "QdbdApp.SchemaDir", "QdbdApp.DiagramRenderer"]).config([
        "$stateProvider",
        function (e) {
            e.state("root.standardShrinkable.home", {
                url: "/",
                views: { "main-content": { templateUrl: "cache/modules/home/home.html" }, "context-menu@root": { template: "<dt-source-editor-menu></dt-source-editor-menu>" } },
                data: { usesCustomPageTitleHandler: !0 },
            })
...
QdbdApp || (QdbdApp = {}),
    angular.module("QdbdApp.Login", []).config([
        "$stateProvider",
        function (e) {
            e.state("root.centered.login", { url: "/sign-in", views: { "main-content": { templateUrl: "cache/modules/login/login.html" } }, data: { isAnonymousOnlyRoute: !0, title: "Login" } });
        },
    ]);
var QdbdApp;
QdbdApp || (QdbdApp = {}),
    angular.module("QdbdApp.MessageScreen", []).config([
        "$stateProvider",
        function (e) {
            e.state("root.centered.successMessage", { url: "/success", views: { "main-content": { templateUrl: "cache/modules/message-screen/message-screen.html" } } }).state("root.centered.errorMessage", {
                url: "/error",
                views: { "main-content": { templateUrl: "cache/modules/message-screen/message-screen.html" } },
            });
        },
    ]);
var QdbdApp;
QdbdApp || (QdbdApp = {}),
    angular.module("QdbdApp.Register", []).config([
        "$stateProvider",
        function (e) {
            e.state("root.centered.register", { url: "/sign-up", views: { "main-content": { templateUrl: "cache/modules/register/register.html" } }, data: { isAnonymousOnlyRoute: !0, title: "Register" } })
                .state("root.centered.setEmail", { url: "/set-email", views: { "main-content": { templateUrl: "cache/modules/register/set-email.html" } }, data: { isAnonymousOnlyRoute: !0, title: "Set Email" } })
                .state("root.centered.confirmEmail", {
                    url: "/confirm-email/:userId/{token:any}",
                    views: { "main-content": { templateUrl: "cache/modules/register/confirm-email.html" } },
                    data: { isAnonymousOnlyRoute: !0, title: "Confirm Email" },
                })
                .state("root.centered.forgotPassword", { url: "/forgot-password", views: { "main-content": { templateUrl: "cache/modules/register/forgot-password.html" } }, data: { isAnonymousOnlyRoute: !0, title: "Forgot Password?" } })
                .state("root.centered.changePassword", { url: "/change-password", views: { "main-content": { templateUrl: "cache/modules/register/change-password.html" } }, data: { isAnonymousOnlyRoute: !1, title: "Change Password" } })
                .state("root.centered.resetPassword", {
                    url: "/reset-password/:userId/{token:any}",
                    views: { "main-content": { templateUrl: "cache/modules/register/reset-password.html" } },
                    data: { isAnonymousOnlyRoute: !1, title: "Reset Password" },
                })
                .state("root.centered.changeEmail", { url: "/change-email", views: { "main-content": { templateUrl: "cache/modules/register/change-email.html" } }, data: { isAnonymousOnlyRoute: !1, title: "Change E-mail" } });
        },
    ]);
var QdbdApp;
...
QdbdApp || (QdbdApp = {}),
    angular.module("QdbdApp.Subscription", []).config([
        "$stateProvider",
        function (e) {
            e.state("root.centered.subscribe", { url: "/subscribe", views: { "main-content": { templateUrl: "cache/modules/subscription/subscribe.html" } }, data: { title: "Subscribe" } })
                .state("root.centered.billingDetails", { url: "/billing-details", views: { "main-content": { templateUrl: "cache/modules/subscription/billing-details.html" } }, data: { title: "Billing Details" } })
                .state("root.centered.checkout", { url: "/checkout", views: { "main-content": { templateUrl: "cache/modules/subscription/checkout.html" } }, data: { title: "Checkout" } })
                .state("root.centered.voucher", { url: "/voucher/:voucherCode", views: { "main-content": { templateUrl: "cache/modules/subscription/subscribe.html" } }, data: { title: "Voucher" } })
                .state("root.centered.discount", { url: "/discount/:discountCode", views: { "main-content": { templateUrl: "cache/modules/subscription/subscribe.html" } }, data: { title: "Discount" } });
        },
    ]);
var QdbdApp;
QdbdApp || (QdbdApp = {}),
    angular.module("QdbdApp.User", []).config([
        "$stateProvider",
        function (e) {
            e.state("root.standard.user", { url: "/user", views: { "main-content": { templateUrl: "cache/modules/user/user.html" }, "context-menu@root": { template: "User" } } })
                .state("root.standard.user.profile", { url: "/:userId/profile", views: { "user-content": { templateUrl: "cache/modules/user/profile.html" } }, data: { title: "Profile" } })
                .state("root.standard.user.diagrams", {
                    url: "/:userId/diagrams?page&pageSize&ownerId&sortBy&search&sortOperator",
                    views: { "user-content": { template: "<dt-user-diagrams filter='UserVM.filter'></dt-user-diagrams>" } },
                    data: { title: "Diagrams" },
                    params: { page: { dynamic: !0 }, pageSize: { dynamic: !0 }, ownerId: { dynamic: !0 }, sortBy: { dynamic: !0 }, search: { dynamic: !0 }, sortOperator: { dynamic: !0 } },
                })
                .state("root.standard.user.payments", { url: "/:userId/payments", views: { "user-content": { template: "<dt-user-payments user-id='UserVM.userId'></dt-user-payments>" } }, data: { title: "Payments" } });
        },
    ]);
var QdbdApp;
...
!(function (e) {
    !(function () {
        function t(e, t, i) {
            (this.$mdDialog = e), (this.SidenavService = t), (this.TrackingService = i);
        }
        (t.$inject = ["$mdDialog", "SidenavService", "TrackingService"]),
            ...
            (t = __decorate([e.Component("QdbdApp.Common", "dtDocs", { templateUrl: "cache/common/components/dt-docs/dt-docs.html", controllerAs: "DtDocsVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        function t(e, t, i) {
            (this.$rootScope = e), (this.AccountService = t), (this.TrackingService = i);
        }
        (t.$inject = ["$rootScope", "AccountService", "TrackingService"]),
            ...
            (t = __decorate([e.Component("QdbdApp.Common", "dtHeader", { templateUrl: "cache/common/components/dt-header/dt-header.html", controllerAs: "DtHeaderVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        ...
        (t.$inject = ["$mdDialog"]),
            ...
            (t = __decorate([e.Component("QdbdApp.Common", "dtLoginRequired", { templateUrl: "cache/common/components/dt-login-required/dt-login-required.html", controllerAs: "DtLoginRequiredVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
...
!(function (e) {
    !(function () {
        function t() { }
        t = __decorate([e.Component("QdbdApp.Common", "dtPager", { bindings: { filter: "=", collection: "=", pager: "=" }, templateUrl: "cache/common/components/dt-pager/dt-pager.html", controllerAs: "DtPagerVM" })], t);
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        ...
        (t.$inject = ["$rootScope", "$transitions", "RoutingService", "SchemaDirService", "TrackingService", "SharingService"]),
            ...
            (t = __decorate([e.Component("QdbdApp.Common", "dtSideToolbar", { templateUrl: "cache/common/components/dt-side-toolbar/dt-side-toolbar.html", controllerAs: "DtSideToolbarVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
        ...
        t = __decorate(
            [
                e.Component("QdbdApp.Common", "dtSortableHeading", {
                    bindings: { filter: "=", pager: "=", name: "@", sortBy: "@" },
...
!(function (e) {
    !(function () {
        ...
        (t.$inject = ["$scope"]),
            ...
            (t = __decorate(
                [e.Component("QdbdApp.Common", "dtValidationSummary", { bindings: { model: "=" }, templateUrl: "cache/common/components/dt-validation-summary/dt-validation-summary.html", controllerAs: "DtValidationSummaryVM" })],
                t
            ));
    })();
})(QdbdApp || (QdbdApp = {}));
...
!(function (e) {
                ...
                get: function () {
                    return {
                        sharing: {
                            ...
                            providers: { twitter: "https://twitter.com/intent/tweet?text=", google: "https://plus.google.com/share?url=", linkedin: "http://www.linkedin.com/shareArticle?mini=true&url=" },
                        },
                    };
                },
                enumerable: !1,
    ...
    (e.AppConfigShared = t), angular.module("QdbdApp.Common").constant("AppConfigShared", t.Default);
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        ...
        return (
            Object.defineProperty(e, "Default", {
                get: function () {
                    return {
                        webApp: { host: "Test", cookieConsentDomain: "test" },
                        webApi: { host: "Test" },
                        buildVersion: "v1.2.7.139",
                        intercom: { appId: "m0fu80bu" },
                        socialAuth: {
                         
                        },
                        firebase: { apiKey: "AIzaSyDAv61hXgFhV69MURFEfXFTzC-EAeOnToE", databaseURL: "https://quickdbd.firebaseio.com" },
                    };
                },
                enumerable: !1,
                configurable: !0,
    ...
    (e.AppConfigRelease = t), angular.module("QdbdApp.Common").constant("AppConfig", t.Default);
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
            ...
            Object.defineProperty(e, "Default", {
                get: function () {
                    return {
                        ...
                        aliasSchemaSections: { rels: "relationships" },
                        allowedRelTypes: [
                            { caption: "One-TO-one", symbol: "-" },
                            { caption: "One-TO-many", symbol: "-<" },
                            { caption: "Many-TO-one", symbol: ">-" },
                            { caption: "Many-TO-many", symbol: ">-<" },
                            { caption: "One-TO-zero-or-one", symbol: "-0" },
                            { caption: "Zero-or-one-TO-one", symbol: "0-" },
                            { caption: "Zero-or-one-TO-zero-or-one", symbol: "0-0" },
                            { caption: "One-TO-zero-or-many", symbol: "-0<" },
                            { caption: "Zero-or-many-TO-one", symbol: ">0-" },
                        ],
                        tableSeparator: "-",
                    };
                },
    ...
    (e.QdbdParserConfig = t), angular.module("QdbdApp.Common").constant("QdbdParserConfig", t.Default);
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
...
!(function (e) {
    function t(e, t) {
        return _.extend(e, {
            restrict: "E",
            scope: { model: "=", rootModel: "=", disable: "=", showExtraValidation: "=", collectionName: "@", propertyName: "@", inputType: "@", label: "@", icon: "@", focusOn: "@", minDate: "=" },
            controller: t || i,
        });
    }
    var i = (function () {
        function e(e, t, i) {
            (this.$scope = e), (this.AccountService = t), (this.ModelStateService = i), (this.modelStatePropertyName = this.ModelStateService.getModelStatePropertyName(e));
            var n = "model." + this.$scope.propertyName;
            (this.$scope.validationMessage = ""),
                (this.$scope.onFieldClicked = this.onFieldClicked.bind(this)),
                this.$scope.$watch(n, this.onWatchedItemChanged.bind(this)),
        ...
        return (
            ...
            (e.prototype.onWatchedItemChanged = function (e, t, i) {
                e !== t && (e || t) && (this.ModelStateService.resetPropertyModelState(this.modelStatePropertyName, this.getModelState()), (this.$scope.validationMessage = ""));
            }),
    ...
    var n = (function (e) {
        ...
        return (
            ...
            (t.prototype.onWatchedItemChanged = function (t, i) {
                t !== i && (t || i) && (e.prototype.onWatchedItemChanged.call(this, t, i, void 0), (this.$scope.passwordValidation = this.AccountService.validatePassword(t)));
            }),
            t
        );
    })(i);
    (e.DtInputPasswordCtrl = n),
        angular
            .module("QdbdApp.Common")
            .directive("dtInputText", function () {
                return t({ templateUrl: "cache/common/directives/dt-form-elements/dt-input-text.html" });
            })
            .directive("dtInputTextI", function () {
                return t({ templateUrl: "cache/common/directives/dt-form-elements/dt-input-text-i.html" });
            })
            .directive("dtInputTextarea", function () {
                return t({ templateUrl: "cache/common/directives/dt-form-elements/dt-input-textarea.html" });
            })
            .directive("dtInputPassword", function () {
                return t({ templateUrl: "cache/common/directives/dt-form-elements/dt-input-password.html" }, n);
            })
                ...
                return {
                    ...
                    link: function (e, t, i, n) {
                        t.on("keydown", function (e) {
                            return !([110, 190].indexOf(e.which) > -1 && (e.preventDefault(), 1));
                        });
                    },
                };
            });
    ...
    var t = (function () {
        ...
        return (
            (t.prototype.getModelStatePropertyName = function (e) {
                ...
                var n = this.capitalizeFirstLetter(e.propertyName);
...
!(function (e) {
        ...
        return function (t) {
            if (t) {
                var i = t.split("-"),
                    ...
                    o = !n || i.length > 2 ? "+" : "",
                    r = { M: n ? "?" : "Ctrl", A: n ? "Option" : "Alt", S: "Shift" };
                return i
                    .map(function (e, t) {
    ...
    (t.$inject = ["$window"]), angular.module("QdbdApp.Common").filter("keyboardShortcut", t);
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        function t(e, t, i, n, o, r, a, s, c, d, l, u) {
            (this.$rootScope = e),
                (this.$http = t),
                (this.$cookies = i),
                (this.$state = n),
        ...
        return (
            (t.$inject = ["$rootScope", "$http", "$cookies", "$state", "$q", "$mdDialog", "$auth", "localStorageService", "BaseHttpService", "AppStateService", "ToastService", "TrackingService"]),
            (t.prototype.login = function (e) {
                ...
                this.clearLocalStorageData(),
                    ...
                    this.$auth.login(e).then(
                        function () {
                            t.resolveCurrentUser(), t.ToastService.showInfo("You are now logged in."), t.$state.go("root.standardShrinkable.home");
                        },
                        function (t) {
                            (e.modelState = t.data.modelState), t.data && t.data.error_description && ((e.modelState = {}), (e.modelState[""] = [t.data.error_description]));
                        }
                    );
            }),
                ...
                this.clearLocalStorageData(),
                    this.$auth.authenticate(e).then(function () {
                        t.resolveCurrentUser().then(
                            function (e) {
                                t.ToastService.showInfo("You are now logged in."), t.$state.go("root.standardShrinkable.home");
                            },
                            function (e) {
                ...
                this.clearLocalStorageData(),
                    ...
                    ((e.confirmPassword = e.password),
                        this.BaseHttpService.post("api/v1/account/register", e, function (e) {
                            t.$auth.setToken(e.data.access_token), t.resolveCurrentUser(), t.ToastService.showInfo("Thanks for registering! Please check your email.");
                        }));
            }),
            (t.prototype.resolveCurrentUser = function () {
                ...
                return !this.$auth.isAuthenticated() && this.$rootScope.currentUser
                    ? ((this.$rootScope.currentUser = void 0), this.$rootScope.$broadcast("current-user-changed"), t.resolve(), t.promise)
                    : (this.$http.get("api/v1/account/userInfo").then(
                        function (i) {
                            (e.$rootScope.currentUser = i.data), e.$rootScope.$broadcast("current-user-changed"), e.TrackingService.updateUser(e.$rootScope.currentUser), e.reAuthenticateIfNecessary(), t.resolve(i);
                        },
                        function (i) {
                            (e.$rootScope.currentUser = void 0), e.$rootScope.$broadcast("current-user-changed"), t.reject(i);
                        }
                    ),
                        t.promise);
            }),
            (t.prototype.clearLocalStorageData = function () {
                this.localStorageService.remove(this.SHORTCODE_KEY), this.localStorageService.remove(this.EXPANDED_DIR_IDS_KEY);
            }),
            ...
            (t.prototype.confirmEmail = function (e, t) {
                return this.BaseHttpService.post("api/v1/account/confirmEmail", { userId: e, token: t });
            }),
            ...
            (t.prototype.validatePassword = function (e) {
                var t = { minCharacters: e && e.length >= 8, lowercase: !!/^(?=.*[a-z])/.exec(e), uppercase: !!/^(?=.*[A-Z])/.exec(e), digits: !!/^(?=.*\d)/.exec(e) };
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.diagramFactory = function () {
                ...
                return (this.currentDiagram && this.currentDiagram.shortcode === e) || (this.currentDiagram = { shortcode: e }), this.currentDiagram;
            }),
...
!(function (e) {
    var t = (function () {
        function t(e, t, i, n) {
            (this.$rootScope = e), (this.$timeout = t), (this.$window = i), (this.localStorageService = n), (this.TOUR_SEEN_KEY = "tourSeen");
        }
        return (
            (t.$inject = ["$rootScope", "$timeout", "$window", "localStorageService"]),
            (t.prototype.initializeTour = function () {
                var e = this;
                this.isTourSeen() ||
                    this.$timeout(function () {
                        var t = new e.$window.Shepherd.Tour({ defaults: { classes: "shepherd-theme-arrows" } });
                        $(window).width() < 600 ? e.createSmallScreenTour(t) : e.createDefaultTour(t),
                            t.on("complete", function () {
                                angular.element(".tour-overlay-container").removeClass("visible"), angular.element(".tour-overlay").removeClass("active visible"), e.markTourAsSeen();
                            }),
                            t.start();
                    });
            }),
            (t.prototype.createSmallScreenTour = function (e) {
                e.addStep("Welcome", {
                    ...
                    when: {
                        show: function () {
                            angular.element(".tour-overlay-container").addClass("visible"), angular.element(".tour-overlay").addClass("active visible");
                        },
                    },
                    buttons: { text: "Ok", action: e.complete, classes: "exit-tour" },
                });
            }),
            (t.prototype.createDefaultTour = function (e) {
                var t = [
                    { text: "Exit", action: e.complete, classes: "exit-tour" },
                    { text: "Next", action: e.next },
                ];
                e.addStep("Welcome", {
                    title: "Welcome to QuickDBD!",
                    ...
                    e.addStep("Renderer", {
                        ...
                        when: {
                            show: function () {
                                angular.element(".editor-overlay").addClass("visible"), angular.element(".renderer-overlay").removeClass("visible");
                            },
                        },
                        buttons: t,
                    }),
                    e.addStep("Docs", {
                        ...
                        when: {
                            show: function () {
                                angular.element(".renderer-overlay").addClass("visible"), angular.element(".header-overlay").removeClass("visible");
                            },
                        },
                        buttons: { text: "Exit", action: e.complete, classes: "exit-tour" },
                    });
            }),
...
!(function (e) {
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.request = function (e, t, i, n) {
                i.modelState = {};
                var o = this.$http[t](e, i);
                return (
                    o.then(n, function (e) {
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.initialize = function () {
                ...
                (this.isUnsupported = _.includes(e, "Trident")), (this.isSpecial = !bowser.check({ chrome: "69", opera: "55" }, !0, e));
            }),
    ...
    var t = (function () {
        ...
        return (
            (t.prototype.getUniqHash = function (e) {
                var t, i, n, o, r, a, s, c;
                for (t = 3 & e.length, i = e.length - t, n = 7, r = 3432918353, a = 461845907, c = 0; c < i;)
                            ...
                            (65535 &
                                (o =
                                    (5 *
                                        (65535 &
                                            (n =
                                                ((n ^= s = ((65535 & (s = ((s = ((65535 & s) * r + ((((s >>> 16) * r) & 65535) << 16)) & 4294967295) << 15) | (s >>> 17))) * a + ((((s >>> 16) * a) & 65535) << 16)) & 4294967295) << 13) |
                                                (n >>> 19))) +
                                        (((5 * (n >>> 16)) & 65535) << 16)) &
                                    4294967295)) +
                            (((58964 + (o >>> 16)) & 65535) << 16));
                switch (((s = 0), t)) {
                    ...
                    case 1:
                        n ^= s = ((65535 & (s = ((s = ((65535 & (s ^= 255 & e.charCodeAt(c))) * r + ((((s >>> 16) * r) & 65535) << 16)) & 4294967295) << 15) | (s >>> 17))) * a + ((((s >>> 16) * a) & 65535) << 16)) & 4294967295;
                }
                return (
                    (n ^= e.length),
                    (n ^= n >>> 16),
...
!(function (e) {
    var t = (function () {
        function t(e, t, i) {
            (this.$mdDialog = e), (this.$window = t), (this.$document = i), this.trackTabFocus();
        }
        return (
            ...
            (t.prototype.onFocusChange = function () {
                var e;
                !document.hidden && this.onVisibilityChange && ((e = this.onVisibilityChange).fn.apply(e, this.onVisibilityChange.params), (this.onVisibilityChange = null));
            }),
            (t.prototype.showDialogNotification = function (e, t) {
                document.hidden
                    ? (this.onVisibilityChange = { fn: this.showDialogNotification.bind(this), params: [e, t] })
                    : this.$mdDialog.show({
                        template:
            ...
            (t.prototype.closDialogNotification = function () {
                document.hidden ? (this.onVisibilityChange = { fn: this.closDialogNotification.bind(this) }) : this.$mdDialog.cancel();
            }),
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.logError = function (e) {
                ...
                return this.$http.post("api/v1/error/log", { error: t });
            }),
...
!(function (e) {
        ...
        function e(e, t, i, n) {
            ...
            (this.$rootScope = e),
                ...
                (this.request = function (e) {
                    return (e.headers = e.headers || {}), _.startsWith(e.url, "api") ? (e.url = "//" + o.AppConfig.webApi.host + "/" + e.url) : (e.headers.Authorization = void 0), e || o.$q.when(e);
                }),
                (this.responseError = function (e) {
                    return (
                        0 === e.status && o.$rootScope.$broadcast("error-message", { header: "Unable to use the Internet connection", message: "The webpage can't load any data because your computer isn?t connected to the Internet." }),
                        401 !== e.status || o.isUserInfoUrl(e)
                            ? 404 === e.status
                                ? o.$rootScope.$broadcast("error-message", { message: "Resource does not exist", status: 404 })
                                : 409 === e.status
                                    ? e.data instanceof ArrayBuffer || o.$rootScope.$broadcast("toast-error", e.data || "An unknown error occured")
                                    : 403 === e.status ||
                                    422 === e.status ||
                                    (e.data && !o.isUserInfoUrl(e) && (e.data.exceptionMessage ? o.$rootScope.$broadcast("toast-error", e.data.exceptionMessage) : e.data.message && o.$rootScope.$broadcast("toast-error", e.data.message)))
                            : o.$rootScope.$broadcast("unauthorized-request", e),
                        o.$q.reject(e)
                    );
                });
        }
        return (
            (e.Factory = function (t, i, n, o) {
    ...
    (e.HttpRequestInterceptor = t), angular.module("QdbdApp.Common").factory("httpRequestInterceptorFactory", t.Factory);
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        ...
        return (
            (t.$inject = ["$state"]),
            (t.prototype.pagerFactory = function (e, t, i, n) {
                var o = this;
                return {
                    onFilterChanged: function (t, r) {
                        o.onFilterChanged(t, r, e, i.bind(o), n);
                    },
                    sort: function (t) {
                        o.sort(t, e);
                    },
                    isFirstPage: function () {
                        return o.isFirstPage(e);
                    },
                    isLastPage: function () {
                        return o.isLastPage(e, t);
                    },
                    prev: function () {
                        return o.prev(e);
                    },
            ...
            (t.prototype.onFilterChanged = function (e, t, i, n, o) {
                e.search !== t.search && 1 !== i.page ? (i.page = 1) : n(), o && this.$state.go(o, _.extend(this.$state.params, i));
            }),
            (t.prototype.sort = function (e, t) {
                t.sortBy && t.sortBy === e ? (t.sortOperator = "descending" === t.sortOperator ? "ascending" : "descending") : ((t.sortBy = e), (t.sortOperator = "ascending"));
            }),
            ...
            (t.prototype.next = function (e, t) {
                e.page || (e.page = 1), e.page++, e.page > t.pageCount && (e.page = t.pageCount);
            }),
...
!(function (e) {
    var t = (function () {
        ...
        return (
            (t.$inject = ["$state", "$window", "$location", "AppConfigShared", "TrackingService"]),
            (t.prototype.share = function (e) {
                this.TrackingService.trackShare("get_link" === e ? "LINK" : e.toUpperCase()), this.isDiagramState() ? this.shareUrl(this.$location.absUrl(), e) : this.shareUrl("https://www.quickdatabasediagrams.com/", e);
            }),
            (t.prototype.shareUrl = function (e, t) {
                var i = this.isDiagramState();
                switch (t) {
                    case "twitter":
                        var n = i ? this.diagramTitleTextTwitter : this.landingTitleTextTwitter,
                            o = this.getTwitterShareLink(e, n);
                        this.shareLink(o);
                        break;
                    case "facebook":
                        ...
                        break;
                    case "google":
                        o = this.getGoogleShareLink(e);
                        this.shareLink(o);
                        break;
                    case "linkedin":
                        var r = i ? this.diagramTitleText : this.landingTitleText,
                            o = this.getLinkedinShareLink(e, r, this.descriptionText);
                        this.shareLink(o);
                        break;
                    default:
                        return;
            ...
            (t.prototype.shareLink = function (e) {
                var t = this.$window.screenLeft,
                    ...
                    n =
                        ...
                        ((this.$window.innerWidth ? this.$window.innerWidth : document.documentElement.clientWidth ? document.documentElement.clientWidth : screen.width) / 2 - 300 + t) +
                        ",top=" +
                        ((this.$window.innerHeight ? this.$window.innerHeight : document.documentElement.clientHeight ? document.documentElement.clientHeight : screen.height) / 2 - 300 + i);
                this.$window.open(e, "a", n).focus();
            }),
            (t.prototype.facebookShare = function (e, t, i) {
                this.$window.FB.ui({ method: "feed", name: t, link: encodeURI(e), picture: this.AppConfigShared.sharing.defaultImage, description: i, message: "" });
            }),
            ...
            (t.prototype.tweet = function (e) {
                ...
                (t = t.replace("TWITTER_LOVE_EMOJI", "%F0%9F%98%8D")), this.shareLink(t);
            }),
...
!(function (e) {
    var t = (function () {
        function t(e) {
            (this.$rootScope = e), (this.rightSidenav = { isOpen: !1 });
        }
        return (
            (t.$inject = ["$rootScope"]),
...
!(function (e) {
    var t = (function () {
        function t(e, t, i, n) {
            (this.$http = e), (this.$log = t), (this.FileSaver = i), (this.ToastService = n);
        }
        return (
            ...
            (t.prototype.downloadFromBlob = function (e, t) {
                ...
                return this.$http.get(n, this.buildRequestConfig()).then(function (t) {
                    i.saveFile(e, t.data, "application/octet-stream"), URL.revokeObjectURL(n);
                }, this.onError.bind(this));
            }),
            (t.prototype.buildRequestConfig = function (e) {
                return { cache: !1, responseType: "arraybuffer", params: e };
            }),
            (t.prototype.onSuccess = function (e) {
                var t = e.headers(),
                    i = t["x-filename"] ? decodeURIComponent(escape(t["x-filename"])) : "download",
                    n = t["content-type"] || "application/octet-stream";
                this.saveFile(i, e.data, n);
            }),
            ...
            (t.prototype.handleException = function (e) {
                this.ToastService.showWarning("Blob download not supported by your browser, please try in Chrome"), this.$log.error(e);
            }),
...
!(function (e) {
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.showToastWithAction = function (e, t, i, n) {
                this.$mdToast.show(this.$mdToast.simple().textContent(e).action(t).highlightAction(!0).highlightClass("md-accent").position("bottom right").hideDelay(4e3).theme(this.getToastTheme(n))).then(function (e) {
                    "ok" === e && i();
                });
            }),
...
!(function (e) {
    var t = (function () {
        function t(e, t, i, n, o, r, a) {
            (this.$rootScope = e), (this.$window = t), (this.$filter = i), (this.$location = n), (this.$state = o), (this.AppConfig = r), (this.AppTourService = a), (this.isChatEnabled = !1);
        }
        return (
            (t.$inject = ["$rootScope", "$window", "$filter", "$location", "$state", "AppConfig", "AppTourService"]),
            (t.prototype.initializeIntercom = function () {
                this.$window.Intercom && this.$window.Intercom("boot", { app_id: this.AppConfig.intercom.appId, hide_default_launcher: !this.isChatEnabled });
            }),
            (t.prototype.flipSupportChat = function () {
                (this.isChatEnabled = !this.isChatEnabled), this.restartIntercom();
            }),
            (t.prototype.enableIntercomChat = function () {
                this.$window.Intercom && this.$window.Intercom("update", { hide_default_launcher: !1 });
            }),
            (t.prototype.restartIntercom = function () {
                this.$window.Intercom && (this.$window.Intercom("shutdown"), this.initializeIntercom());
            }),
            (t.prototype.updateUser = function (e) {
                if (this.$window.Intercom) {
                    if (!e) return void this.$window.Intercom("update", { email: void 0 });
                    this.$window.Intercom("update", {
                        ...
                        profile_url: this.$state.href("root.standard.user.profile", { userId: e.userId }, { absolute: !0 }),
            ...
            (t.prototype.onRouteChange = function () {
                this.$window.gtag && this.$window.gtag("config", this.$window.GA_TRACKING_ID, { page_path: this.$location.url() }), this.$window.Intercom && this.$window.Intercom("update");
            }),
            (t.prototype.trackNewFile = function () {
                this.trackEvent("New File", "Menu", "File", "", 0, { created_at: this.getFormattedTimeNow() });
            }),
            (t.prototype.trackNewFolder = function () {
                this.trackEvent("New Folder", "Menu", "File", "", 0, { created_at: this.getFormattedTimeNow() });
            }),
            (t.prototype.trackSave = function () {
                this.trackEvent("Save Diagram", "Menu", "File", "", 0, { url: this.$window.location.href, saved_at: this.getFormattedTimeNow() });
            }),
            (t.prototype.trackShare = function (e) {
                this.trackEvent("Share Diagram", "Menu", "Social", e, 0, { type: e, url: this.$window.location.href, shared_at: this.getFormattedTimeNow() });
            }),
            (t.prototype.trackColorPalette = function (e) {
                this.trackEvent("Color Palette", "Menu", "File", e, 0, { changed_at: this.getFormattedTimeNow() });
            }),
            ...
            (t.prototype.trackExport = function (e, t) {
                ...
                this.trackEvent(e, "Menu", "Export", i, 0, { type: t, url: this.$window.location.href, exported_at: this.getFormattedTimeNow() });
            }),
            (t.prototype.trackImportFromSql = function (e) {
                ...
                this.trackEvent("Import from SQL", "Menu", "Import", t, 0, { type: e, url: this.$window.location.href, exported_at: this.getFormattedTimeNow() });
            }),
            ...
            (t.prototype.trackPurchase = function (e, t) {
                this.trackEvent("Subscribed", "Commerce", "Purchase", t, e, { type: t, purchased_at: this.getFormattedTimeNow() });
            }),
            (t.prototype.trackEvent = function (e, t, i, n, o, r) {
                this.$window.gtag && this.$window.gtag("event", e, { event_category: t, event_action: i || "click", event_label: n, value: o || 0 }), r && this.$window.Intercom && this.$window.Intercom("trackEvent", _.snakeCase(e), r);
            }),
            ...
            (t.prototype.profitWellTrack = function () {
                var e = { event: "start_pw" };
                this.$rootScope.currentUser && this.$rootScope.currentUser.email && (e.pw_user_email = this.$rootScope.currentUser.email), dataLayer && dataLayer.push && dataLayer.push(e);
            }),
...
!(function (e) {
    !(function () {
        function t(e, t) {
            (this.$state = e), (this.$timeout = t), this.initializeFilters(), this.setupRoutes(), this.handleRouting();
        }
        (t.$inject = ["$state", "$timeout"]),
            (t.prototype.setupRoutes = function () {
                var e = this;
                (this.routes = [
                    { caption: "Users", name: "root.standard.admin.userList" },
                    { caption: "Diagrams", name: "root.standard.admin.diagramList" },
                    { caption: "Vouchers", name: "root.standard.admin.vouchersList" },
                ]),
                    this.$timeout(function () {
                        e.selectedTab = _.findIndex(e.routes, { name: e.$state.current.name });
                    });
            }),
            ...
            (t.prototype.initializeFilters = function () {
                var e = { page: this.$state.params.page || 1, pageSize: this.$state.params.pageSize || 20, search: this.$state.params.search, sortBy: this.$state.params.sortBy, sortOperator: this.$state.params.sortOperator };
                (this.usersFilter = { page: e.page, pageSize: e.pageSize, search: e.search, sortBy: e.sortBy || "email", sortOperator: e.sortOperator }),
                    (this.schemasFilter = { page: e.page, pageSize: e.pageSize, search: e.search, sortBy: e.sortBy || "schemaSourceId", sortOperator: e.sortOperator }),
                    (this.voucherFilter = { page: e.page, pageSize: e.pageSize, search: e.search, sortBy: e.sortBy || "voucherId", sortOperator: e.sortOperator });
            }),
...
!(function (e) {
    !(function () {
        function t(e, t, i, n) {
            (this.$scope = e), (this.$mdDialog = t), (this.CollaboratorsService = i), (this.ToastService = n), (this.model = {}), (this.collaborators = []);
        }
        (t.$inject = ["$scope", "$mdDialog", "CollaboratorsService", "ToastService"]),
            ...
            (t.prototype.addCollaborator = function () {
                var e = this;
                "dir" === this.collabType ? ((this.model.dirId = this.identifier), (this.model.shortcode = 0)) : ((this.model.dirId = 0), (this.model.shortcode = this.identifier)),
            ...
            (t.prototype.removeCollaborator = function (e) {
                var t = this,
                    ...
                    n = this.$mdDialog.confirm().title("Remove collaborator").htmlContent(i).ok("Yes").cancel("No").multiple(!0).clickOutsideToClose(!0);
                this.$mdDialog.show(n).then(function () {
                    t.CollaboratorsService.removeCollaborator(e).then(function () {
                        t.loadCollabs(), t.ToastService.showInfo("Collaborator successfully removed");
                    });
                });
            }),
            (t.prototype.closeDialog = function () {
            ...
            (t = __decorate(
                [
                    e.Component("QdbdApp.Collaborators", "dtCollaborators", {
                        bindings: { identifier: "@", collabType: "@", isOwnedByCurrentUser: "=" },
    ...
    var t = (function () {
        function t(e, t, i, n, o, r) {
            (this.$rootScope = e),
                ...
                (this.StreamDownloadService = n),
                (this.BrowserSupportService = o),
                (this.ToastService = r),
                (this.defaults = { topLeft: { x: 20, y: 12 }, padding: { x: 22, y: 30 } });
        }
        return (
            (t.$inject = ["$rootScope", "$log", "TrackingService", "StreamDownloadService", "BrowserSupportService", "ToastService"]),
            (t.prototype.exportToSVG = function (e, t) {
                try {
                    ...
                    this.StreamDownloadService.downloadFromString(n + ".svg", "data:application/svg+xml;charset=utf-8," + encodeURIComponent(i));
                } catch (e) {
                    this.ToastService.showWarning("SVG export failed, please try in Chrome"), this.$log.error(e);
                }
            }),
            (t.prototype.exportToPNG = function (e, t) {
                var i = this;
                if (this.BrowserSupportService.isSpecialSnowflakeBrowser()) this.ToastService.showWarning("PNG export is unsupported by your browser. Please try Chrome, Brave or Opera.");
                else
                    try {
                        this.TrackingService.trackExportToImg("png");
                        var n = this.generateSVG(e, t),
                            o = this.createExportImageName(e),
                            r = this.getBoundingBoxDimensions(e),
                            a = document.createElement("canvas"),
                            s = a.getContext("2d"),
                            c = new Image();
                        (c.src = "data:image/svg+xml;utf8," + encodeURIComponent(n)),
                            (c.onload = function () {
                                (a.width = r.width),
                                    (a.height = r.height),
                                    s.drawImage(c, 0, 0),
                                    s.canvas.toBlob(function (e) {
                                        i.StreamDownloadService.downloadFromBlob(o + ".png", e);
                                    });
                            });
                    } catch (e) {
                        this.ToastService.showWarning("PNG export failed, please try in Chrome"), this.$log.error(e);
                    }
            }),
            (t.prototype.generateSVG = function (e, t) {
                var i = angular.copy(angular.element(".canvas")),
                    n = i.find(".drawing-wrapper")[0],
                    o = this.getTopLeftPoint(e, t);
                n.setAttribute("transform", "translate(" + -o.x + ", " + -o.y + ") scale(1,1)");
                var r = i[0].innerHTML,
                    a = $(r).wrapAll("<div>");
                return (
            ...
            (t.prototype.getTopLeftPoint = function (e, t) {
                ...
                var n = _.size(t.sections.tables) === _.size(e.layout);
                return (
                    _.isEmpty(i) ? ((i.x = this.defaults.topLeft.x), (i.y = this.defaults.topLeft.y)) : n || ((i.x = _.min([this.defaults.topLeft.x, i.x])), (i.y = _.min([this.defaults.topLeft.y, i.y]))),
            ...
            (t.prototype.getBoundingBoxDimensions = function (e) {
                ...
                return { height: (100 * t.height) / i + 3 * this.defaults.padding.x, width: (100 * t.width) / i + 2 * this.defaults.padding.y };
            }),
        ...
        (t.$inject = ["$rootScope", "$scope", "$timeout", "QRendService", "QRendConfig", "SourceEditorService", "SchemaFirebaseService", "BrowserSupportService", "TrackingService"]),
            (t.prototype.onRenderDiagram = function (e, t, i) {
                ...
                (this.diagram = t),
                    (this.qdbdSchema = i),
                    this.$timeout(function () {
                        n.QRendService.initializeRendering(i, t, n.getDiagramStyle());
                    });
            }),
            (t.prototype.getDiagramStyle = function () {
                var e = angular.copy(this.QRendConfig.style);
                return this.SourceEditorService.isBasicPaletteActive() && _.merge(e, this.QRendConfig.basicStyle), e;
            }),
            (t.prototype.registerOnSidebarResizeHandler = function () {
                ...
                angular.element("#dragger").mousedown(function (t) {
                    ...
                    var i = angular.element("#main-content").width(),
                        n = angular.element(".side-toolbar").width();
                    angular.element(document).mousemove(function (t) {
                        var o = (100 * (t.pageX - n)) / i;
                        o < 0 && (o = 0),
                            e.$timeout(function () {
                                e.SourceEditorService.editorSize.x = o;
                            });
                    });
                }),
                    angular.element(document).mouseup(function () {
                        angular.element(document).unbind("mousemove"), e.SourceEditorService.saveLocalEditorSize();
                    });
            }),
            ...
            (t.prototype.zoomIn = function () {
                ...
                (e = this.SourceEditorService.resolveZoomDiffValue(e, 10)), this.$rootScope.$broadcast("diagram-zoom-set", e, !0), this.TrackingService.trackZoom(e, "IN");
            }),
            (t.prototype.setZoom = function (e) {
                this.$rootScope.$broadcast("diagram-zoom-set", e, !0), this.TrackingService.trackZoom(e, "SET");
            }),
            (t.prototype.zoomOut = function () {
                var e = this.diagram.viewport.zoom;
                (e = this.SourceEditorService.resolveZoomDiffValue(e, -10)), this.$rootScope.$broadcast("diagram-zoom-set", e, !0), this.TrackingService.trackZoom(e, "OUT");
            }),
            (t = __decorate([e.Component("QdbdApp.DiagramRenderer", "dtDiagramRenderer", { templateUrl: "cache/modules/diagram-renderer/dt-diagram-renderer.html", controllerAs: "DtDiagramRendererVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        function t(e, t, i, n, o) {
            (this.$state = e), (this.$mdDialog = t), (this.$window = i), (this.SharingService = n), (this.ToastService = o);
        }
        (t.$inject = ["$state", "$mdDialog", "$window", "SharingService", "ToastService"]),
            ...
            (t.prototype.copyToClipboard = function () {
                $("#shotcode-link").select(), document.execCommand("copy"), this.ToastService.showInfo("Copied to clipboard."), this.$mdDialog.cancel();
            }),
            (t.prototype.resolveShortcodeLink = function () {
                this.shortcodeLink = this.shortcode ? this.$state.href("root.standardShrinkable.diagram", { shortcode: this.shortcode }, { absolute: !0 }) : this.$state.href("root.standardShrinkable.home", null, { absolute: !0 });
            }),
            (t.prototype.socialShare = function (e) {
                this.SharingService.share(e);
            }),
            ...
            (t = __decorate([e.Component("QdbdApp.DiagramRenderer", "dtShortcode", { bindings: { shortcode: "@" }, templateUrl: "cache/modules/diagram-renderer/dt-shortcode.html", controllerAs: "DtShortcodeVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
        ...
        return (
            Object.defineProperty(e, "Default", {
                get: function () {
                    return {
                        style: {
                            canvas: { background: "#f5f6f6" },
                            table: {
                                minWidth: 64,
                                minMidSpacing: 20,
                                header: { background: "#005aa0", color: "#fff", border: {}, height: 40, padding: { x: 13, y: 25 }, highlighting: { color: "#1b9bff" } },
                                contentPadding: { height: 5 },
                                field: {
                                    background: "#fff",
                                    ...
                                    icon: {
                                        color: "#c2c7ce",
                                        rightOffset: 5,
                                        pk: { scale: 0.65, width: 15, offset: { y: 3 } },
                                        uniq: { scale: 0.5, width: 11, offset: { y: 5.5 } },
                                        index: { fill: "#afb3b6", stroke: "#000", scale: 0.014, width: 10, offset: { y: 5 } },
                                    },
                                    highlighting: { color: "#e7f4ff" },
                                },
                            },
                            relationship: {
                                verticalOverlapOffset: 60,
                                stroke: { color: "#c3c3c3", width: 1 },
                                hover: { stroke: { color: "#323c46", opacity: 0.035, width: 13 } },
                                delete: { circle: { radius: 6, color: "#fa5a3c" }, x: { width: 1, radius: 3, color: "white" } },
                                highlighting: { color: "#1b9bff" },
                            },
                            layout: { nonExisting: { padding: 30, width: 175 } },
                            port: {
                                maxBasePull: 50,
                                pullCoefficient: 1.6,
                                defaultRadius: 1,
                                offset: { x: 12, y: 17 },
                                one: { height: 6, offset: { x: 6 } },
                                many: { length: 7, height: 6 },
                                zeroOne: { radius: 3, offset: { x: 5 } },
                                zeroMany: { radius: 2.5 },
                                connector: { radius: 4, sameSideThreshold: 40, color: "#d2d2dc", padding: { y: 12 } },
                            },
                        },
                        basicStyle: {
                            canvas: { background: "white" },
                            table: {
                                header: { background: "white", color: "#323c46", fontWeight: "bold", border: { color: "#323c46", width: 2 }, highlighting: { color: "#323c46", textColor: "white" } },
                                field: {
                                    color: "#323c46",
                                    pkColor: "#323c46",
                                    typeColor: "#323c46",
                                    ...
                                    border: { color: "#323c46", width: 2 },
                                    icon: { color: "#a0a0a0", index: { fill: "#a0a0a0", stroke: "#000" } },
                                    highlighting: { color: "#efefef" },
                                },
                            },
                            relationship: { stroke: { color: "#4e4e4e" }, highlighting: { color: "black" } },
                            port: { connector: { color: "#424242" } },
                        },
                        shapes: {
    ...
    (e.QRendConfig = t), angular.module("QdbdApp.DiagramRenderer").constant("QRendConfig", t.Default);
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        function t(e, t) {
            (this.QRendTableService = e), (this.QRendUtilsService = t), this.initializeCache();
        }
        return (
            (t.$inject = ["QRendTableService", "QRendUtilsService"]),
            (t.prototype.initializeCache = function () {
                this.cache = { tableToHl: "", tableHashesToLeave: [], tableHashesToDim: [], relHashesToDim: [], relHashesToHl: [], style: null };
            }),
            ...
            (t.prototype.clickHighlight = function (e, t, i, n) {
                this.resetHighlighting();
                var o = this.getRelsToLeave(e.sections.relationships, t),
                    r = _.map(o, function (e) {
                        return e.hash;
                    }),
                    ...
                    c = this.getTablesIdentifiersToLeave(o, t),
                    ...
                    p = this.getRelHashesToHl(o, i),
                    h = this.getFieldsToHl(e.sections.tables, o, t, i);
                (this.cache = { tableToHl: t, fieldsToHl: h, tableHashesToLeave: d, tableHashesToDim: u, relHashesToHl: p, relHashesToDim: s, style: n }), this.highlight(this.cache);
            }),
            ...
            (t.prototype.getTablesIdentifiersToLeave = function (e, t) {
                ...
                return (
                    _.each(e, function (e) {
                        var n;
                        e.table1.tableIdentifier === t ? (n = e.table2.tableIdentifier) : e.table2.tableIdentifier === t && (n = e.table1.tableIdentifier),
                            n &&
                            !_.find(i, function (e) {
                                return e === n;
                            }) &&
            ...
            (t.prototype.getFieldsToHl = function (e, t, i, n) {
                return n ? [{ tableIdentifier: i, fieldIdentifier: n, fieldIndex: e[i].fields[n].order, tableWidth: null, cssClass: "fhl", drawConnectors: !1 }] : [];
            }),
            (t.prototype.getSecondaryRelMember = function (e, t, i) {
                var n;
                return e.table1.tableIdentifier === t && e.table1.fieldIdentifier === i && (n = e.table2), e.table2.tableIdentifier === t && e.table2.fieldIdentifier === i && (n = e.table1), n;
            }),
            ...
            (t.prototype.highlightFields = function (e, t) {
                var i = this,
                    n = angular.element(".canvas").find(".ts")[0];
                _.each(e, function (e) {
                    var o = i.QRendUtilsService.createTableHtmlId(e.tableIdentifier),
                        r = n.querySelector("#" + o),
    ...
    var t = (function () {
        function t(e, t, i, n, o, r, a, s) {
            (this.$rootScope = e),
                ...
                (this.QRendSvgService = n),
                (this.QRendUtilsService = o),
                (this.QRendEventHighlightService = r),
                (this.SourceEditorService = a),
                (this.TrackingService = s);
        }
        return (
            (t.$inject = ["$rootScope", "QRendTableService", "QRendRelService", "QRendSvgService", "QRendUtilsService", "QRendEventHighlightService", "SourceEditorService", "TrackingService"]),
            (t.prototype.addEventHandlers = function (e, t, i, n) {
                function o(n, o) {
                    function a(e) {
                    ...
                    function s(e, t) {
                        var i = -(e.x - g.x) / t,
                            r = -(e.y - g.y) / t;
                        (n.x += i), (n.y += r), l.setAttribute("x", n.x), l.setAttribute("y", n.y), w.$rootScope.$broadcast("diagram-table-moved", n, o);
                    }
                    function c() {
                        if (!u) {
                            var n = _.filter(e.sections.relationships, function (e) {
                                return e.table1.tableIdentifier === o || e.table2.tableIdentifier === o;
                            });
                            u = _.map(n, function (e) {
                                return { object: e, element: p.querySelector("#" + w.QRendUtilsService.createRelationshipHtmlId(e)) };
                            });
                        }
                        _.each(u, function (n) {
                            w.QRendRelService.updateRelationship(n.element, e, t, n.object, i);
                        });
                    }
                    var d = w.QRendUtilsService.createTableHtmlId(o),
                        l = p.querySelector("#" + d),
                        u = null;
                    l.addEventListener("mousedown", function (e) {
                        (v = a), (u = null), (b = !1), w.QRendUtilsService.moveTableElementToFront(l), e.stopPropagation();
                    }),
                        l.addEventListener("mouseup", function (t) {
                            (v = null), b ? (y = null) : (y || D ? (y = null) : w.QRendEventHighlightService.clickHighlight(e, o), y && y.line && w.$rootScope.$broadcast("diagram-table-row-clicked", y.line));
                        }),
                        l.addEventListener("mouseenter", function (t) {
                            t && (r(e.sections.tables[o], n, o, l), D || l.classList.add("hover"));
                        }),
                        l.addEventListener("mouseleave", function (e) {
                            e && (l.classList.remove("hover"), angular.element(".fa").remove());
                        });
                }
                function r(e, t, n, o) {
                    if (!o.querySelector(".fa")) {
                        var r = parseInt(o.getAttribute("width")),
                            s = o.querySelector(".tf");
                        _.each(e.fields, function (c) {
                            var d = w.QRendTableService.createFieldBackground(
                                { fieldIdentifier: c.identifier, fieldIndex: c.order, tableIdentifier: n, tableWidth: r, cssClass: "fa", drawConnectors: "qdbdvirtualfield" !== c.identifier },
                                i
                            );
                            o.insertBefore(d, s), a(c, e, t, d, o);
                        });
                    }
                }
                function a(n, o, r, a, c) {
                    function d(e) {
                    ...
                    function l(e, i) {
                        e.stopPropagation();
                        var o = t.viewport.zoom / 100,
                            r = u.offset();
                        (v = h), (D = n), (x = c.width.baseVal.value * o);
                        var a = m(e, o);
                        E = { x: a - r.left, y: e.y - r.top, orientation: i.orientation, type: "none" };
                    }
                    function h() {
                        M(), A(w.QRendRelService.createConnectorPath(E, g, i));
                    }
                    function m(e, t) {
                        return document.elementFromPoint(e.clientX, e.clientY).getBoundingClientRect().left + i.port.connector.radius * t;
                    }
                    function C() {
                        D && w.$rootScope.$broadcast("diagram-ports-connected", { fromLine: D.line, toTable: o.caption, toField: n.caption, toLine: n.line }), T();
                    }
                    function M() {
                        "left" === E.orientation ? g.x > E.x + x + i.port.connector.sameSideThreshold && ((E.orientation = "right"), (E.x += x)) : g.x < E.x - x - i.port.connector.sameSideThreshold && ((E.orientation = "left"), (E.x -= x));
                    }
                    function A(e) {
                    ...
                    var k = w.QRendUtilsService.createConnectorHtmlClass(o.identifier, n.identifier),
                        $ = "temp-connection",
                        x = null,
                        E = null,
                        I = null;
                    a.addEventListener("mousedown", function (e) {
                        ...
                        a.addEventListener("mouseup", function (t) {
                            b || y !== n || w.QRendEventHighlightService.clickHighlight(e, o.identifier, n.identifier, i);
                        }),
                        "qdbdvirtualfield" !== n.identifier &&
                        (a.addEventListener("mouseenter", function (e) {
                            D && ((f = C), a.querySelector(".bg").classList.add("hover"));
                        }),
                            a.addEventListener("mouseleave", function (e) {
                                D && ((f = T), a.querySelector(".bg").classList.remove("hover"));
                            }),
                            (function () {
                                var e = c.getElementsByClassName(k);
                                I = { left: { element: e[0], orientation: "left" }, right: { element: e[1], orientation: "right" } };
                            })(),
                            d(I.left),
                            d(I.right));
                }
                ...
                !(function () {
                    function e(e) {
                        (l = !1), (v = o), u.addClass("dragged");
                    }
                    function i(e) {
                        var t = g,
                            i = u.offset();
                        (g = { x: e.clientX - i.left, y: e.clientY - i.top }), v && v(t, g);
                    }
                    function o(e, i) {
                        if (e) {
                            var o = -(e.x - g.x),
                                r = -(e.y - g.y);
                            (t.viewport.position.x += o), (t.viewport.position.y += r), n(h, t.viewport), w.$rootScope.$broadcast("diagram-dragged", t.viewport.position), (l = !0);
                        }
                    }
                    function r(e) {
                        (v = null), f && (f(), (f = null)), u.removeClass("dragged"), d(e), s();
                    }
                    function a(e) {
                        if (w.SourceEditorService.isCanvasMouseZoomEnabled()) {
                            ...
                            (t.viewport.zoom += o), t.viewport.zoom > 200 ? ((t.viewport.zoom = 200), (r = !0)) : t.viewport.zoom < 10 && ((t.viewport.zoom = 10), (r = !0));
                            var s = t.viewport.zoom / 100;
                            if (!r && g) {
                                var c = { x: t.viewport.position.x / a, y: t.viewport.position.y / a },
                                    d = { x: g.x / a, y: g.y / a },
                                    l = { x: d.x - c.x, y: d.y - c.y },
                                    u = { x: g.x / s, y: g.y / s },
                                    p = { x: u.x - l.x, y: u.y - l.y },
                                    m = { x: p.x * s, y: p.y * s };
                                (t.viewport.position.x = m.x), (t.viewport.position.y = m.y);
                            }
                            n(h, t.viewport), w.$rootScope.$broadcast("diagram-viewport-set", t.viewport), w.TrackingService.trackZoom(t.viewport.zoom, i > 0 ? "IN" : "OUT");
                        }
                    }
                    function d(e) {
                        ...
                        a.on("mouseenter", function (a) {
                            if ((m.empty(), !D)) {
                                var s = a.target,
                                    ...
                                    d = _.find(e.sections.relationships, { hash: s.id }),
                                    l = w.QRendRelService.getRelationshipMidpoint(e, t, d, i),
                                    u = w.QRendSvgService.svgPathFactory(c, { class: "hr" }),
                                    p = w.QRendSvgService.svgCircleFactory(l.x, l.y, i.relationship.delete.circle.radius, { class: "dc" }),
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.createRelationships = function (e, t, i) {
                var n = this,
                    o = this.QRendSvgService.svgGroupFactory({ class: "rs" });
                return (
                    _.each(e.sections.relationships, function (r) {
                        var a = n.createRelationship(e, t, r, i);
                        o.appendChild(a);
                    }),
                    o
                );
            }),
            (t.prototype.createRelationship = function (e, t, i, n) {
                var o = this.createRelationshipPath(e, t, i, n);
                return (i.hash = this.QRendUtilsService.createRelationshipHtmlId(i)), this.QRendSvgService.svgRelationshipPathFactory(i.hash, o);
            }),
            (t.prototype.updateRelationship = function (e, t, i, n, o) {
                var r = this.createRelationshipPath(t, i, n, o);
                e.setAttribute("d", r);
            }),
            (t.prototype.createRelationshipPath = function (e, t, i, n) {
                var o = this.createRelationshipPort(e, t, i.table1, n),
                    r = this.createRelationshipPort(e, t, i.table2, n);
                return this.isSelfReferencingRelationship(i)
                    ? this.createSameSideRelationshipPath(o, r, n)
                    : this.isVerticallyOverlappingRelationship(o, r, n)
                        ? (this.adjustSameSidePortOrientation(o, r), this.createSameSideRelationshipPath(o, r, n))
                        : (this.adjustDifferentSidePortOrientation(o, r), this.createDifferentSideRelationshipPath(o, r, n));
            }),
            (t.prototype.getRelationshipMidpoint = function (e, t, i, n) {
                var o = this.createRelationshipPort(e, t, i.table1, n),
                    r = this.createRelationshipPort(e, t, i.table2, n);
                if (this.isSelfReferencingRelationship(i)) {
                    a = this.getCShapedBezier(o, r, n);
                    return this.getCShapeBezierMidpoint(a);
                }
                if (this.isVerticallyOverlappingRelationship(o, r, n)) {
                    this.adjustSameSidePortOrientation(o, r);
                    var a = this.getCShapedBezier(o, r, n);
                    return this.getCShapeBezierMidpoint(a);
                }
                return this.adjustDifferentSidePortOrientation(o, r), this.getSShapedBezier(o, r, n).portMidpoint;
            }),
            ...
            (t.prototype.isVerticallyOverlappingRelationship = function (e, t, i) {
                var n = i.relationship.verticalOverlapOffset;
                return (e.x >= t.x - n && e.x <= t.adjustedRightX + n) || (e.adjustedRightX >= t.x - n && e.adjustedRightX <= t.adjustedRightX + n);
            }),
            (t.prototype.adjustSameSidePortOrientation = function (e, t) {
                var i = Math.abs(e.x - t.x);
                Math.abs(e.adjustedRightX - t.adjustedRightX) < i && ((e.x = e.adjustedRightX), (e.orientation = "right"), (t.x = t.adjustedRightX), (t.orientation = "right"));
            }),
            (t.prototype.createSameSideRelationshipPath = function (e, t, i) {
                var n = this.getCShapedBezier(e, t, i),
                    o =
                        "M" +
                        this.QRendSvgService.formatPathPoint(n.port1) +
                        " C " +
                        this.QRendSvgService.formatPathPoint(n.controlPoint1) +
                        ", " +
                        this.QRendSvgService.formatPathPoint(n.controlPoint2) +
                        ", " +
                        this.QRendSvgService.formatPathPoint(n.port2);
                return this.createRelationshipPathCommand(o, e, t, i);
            }),
            (t.prototype.getCShapedBezier = function (e, t, i) {
                var n = this.calculatePointDistance(e, t) / 3,
                    o = "left" === e.orientation,
                    r = o ? -1 : 1,
                    a = e.x - t.x,
                    s = _.min([n, i.port.maxBasePull]) * r,
                    c = a * i.port.pullCoefficient,
                    d = 0,
                    l = 0;
                return o ? (a < 0 ? (l = c) : (d = -c)) : a < 0 ? (d = -c) : (l = c), { port1: e, controlPoint1: { x: e.x + s + d, y: e.y }, controlPoint2: { x: t.x + s + l, y: t.y }, port2: t };
            }),
            (t.prototype.createDifferentSideRelationshipPath = function (e, t, i) {
                var n = this.getSShapedBezier(e, t, i),
                    o =
                        "M" +
                        this.QRendSvgService.formatPathPoint(n.port1) +
                        " Q " +
                        this.QRendSvgService.formatPathPoint(n.controlPoint) +
                        ", " +
                        this.QRendSvgService.formatPathPoint(n.portMidpoint) +
                        " T " +
                        this.QRendSvgService.formatPathPoint(t);
                return this.createRelationshipPathCommand(o, e, t, i);
            }),
            (t.prototype.createRelationshipPathCommand = function (e, t, i, n) {
                return this.createCrowsFootPath(t, n) + " " + e + " " + this.createCrowsFootPath(i, n);
            }),
            (t.prototype.getSShapedBezier = function (e, t, i) {
                var n = this.calculateMidpoint(e, t);
                return { port1: e, controlPoint: { x: this.calculateMidpoint(e, n).x, y: e.y }, portMidpoint: n, port2: t };
            }),
            (t.prototype.adjustDifferentSidePortOrientation = function (e, t) {
                e.adjustedRightX < t.x ? ((e.x = e.adjustedRightX), (e.orientation = "right")) : e.x > t.adjustedRightX && ((t.x = t.adjustedRightX), (t.orientation = "right"));
            }),
            (t.prototype.createRelationshipPort = function (e, t, i, n) {
                var o = i.tableIdentifier,
                    r = i.fieldIdentifier,
                    a = this.QRendUtilsService.getSchemaField(e, o, r),
                    s = t.layout[o];
                return this.createPort(s, a, i.type, n);
            }),
            (t.prototype.createPort = function (e, t, i, n) {
                var o = e.x,
                    r = _.round(o + e.width, 2),
                    a = o - n.port.offset.x,
                    s = r + n.port.offset.x,
                    c = n.table.header.height - n.table.field.height + (t.order + 1) * n.table.field.height;
                return { x: a, y: e.y + c + n.port.offset.y, baseLeftX: o, baseRightX: r, adjustedLeftX: a, adjustedRightX: s, orientation: "left", type: i };
            }),
            ...
            (t.prototype.createDefaultCrowsFootPath = function (e, t) {
                var i = "left" === e.orientation,
                    n = i ? -1 : 1,
                    o = i ? e.baseLeftX : e.baseRightX;
                return this.createDotPath(o, e.y, t.port.defaultRadius) + " " + this.createLinePath(o, e.y, o + n * t.port.offset.x, e.y);
            }),
            (t.prototype.createOneCrowsFootPath = function (e, t) {
                var i = "left" === e.orientation,
                    ...
                    o = i ? e.baseLeftX : e.baseRightX;
                return (
                    this.createDotPath(o, e.y, t.port.defaultRadius) +
                    " " +
                    this.createLinePath(o, e.y, o + n * t.port.offset.x, e.y) +
                    " " +
                    this.createLinePath(o + n * t.port.one.offset.x, e.y + t.port.one.height, o + n * t.port.one.offset.x, e.y - t.port.one.height)
                );
            }),
            (t.prototype.createManyCrowsFootPath = function (e, t) {
                var i = "left" === e.orientation,
                    n = i ? -1 : 1,
                    o = i ? e.baseLeftX : e.baseRightX;
                return this.createDotPath(o, e.y, t.port.defaultRadius) + " " + this.createLinePath(o, e.y, o + n * t.port.offset.x, e.y) + " " + this.createFootPath(o, e.y, n, t);
            }),
            (t.prototype.createZeroOneCrowsFootPath = function (e, t) {
                ...
                return (
                    this.createDotPath(o, e.y, t.port.defaultRadius) +
                    " " +
                    this.createLinePath(o, e.y, o + n * (r - t.port.zeroOne.radius), e.y) +
                    " " +
                    this.createCirclePath(o + n * r, e.y, t.port.zeroOne.radius) +
                    " " +
                    this.createLinePath(o + n * (r + t.port.zeroOne.radius), e.y, o + n * t.port.offset.x, e.y)
                );
            }),
            (t.prototype.createZeroManyCrowsFootPath = function (e, t) {
                ...
                return (
                    this.createDotPath(o, e.y, t.port.defaultRadius) +
                    " " +
                    this.createLinePath(o, e.y, o + n * t.port.many.length, e.y) +
                    " " +
                    this.createFootPath(o, e.y, n, t) +
                    " " +
                    this.createCirclePath(o + n * (t.port.offset.x - t.port.zeroMany.radius), e.y, t.port.zeroMany.radius)
                );
            }),
            (t.prototype.createLinePath = function (e, t, i, n) {
                var o = this.QRendSvgService.formatPathCoordinates(e, t);
                return "M" + o + " L" + o + " " + this.QRendSvgService.formatPathCoordinates(i, n);
            }),
            (t.prototype.createFootPath = function (e, t, i, n) {
                var o = this.createDotPath(e, t + n.port.many.height, n.port.defaultRadius),
                    r = this.QRendSvgService.formatPathCoordinates(e, t + n.port.many.height);
                return (
                    o +
                    " M" +
                    r +
                    ...
                    r +
                    " " +
                    this.QRendSvgService.formatPathCoordinates(e + i * n.port.many.length, t) +
                    " " +
                    this.QRendSvgService.formatPathCoordinates(e, t - n.port.many.height) +
                    " " +
                    this.createDotPath(e, t - n.port.many.height, n.port.defaultRadius)
                );
            }),
            (t.prototype.createDotPath = function (e, t, i) {
                return i <= 0 ? "" : this.createCirclePath(e, t, i) + " " + this.createDotPath(e, t, i - 0.5);
            }),
            ...
            (t.prototype.calculateMidpoint = function (e, t) {
                return { x: _.round((e.x + t.x) / 2, 2), y: _.round((e.y + t.y) / 2, 2) };
            }),
            (t.prototype.calculatePointDistance = function (e, t) {
                return Math.sqrt(Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2));
            }),
            (t.prototype.createHoverRelationshipsContainer = function () {
                return this.QRendSvgService.svgGroupFactory({ class: "hrs" });
            }),
            (t.prototype.getCShapeBezierMidpoint = function (e) {
                for (var t = [e.port1, e.controlPoint1, e.controlPoint2, e.port2], i = [], n = 1; n < 4; n++) {
                    var o = this.calculateMidpoint(t[n - 1], t[n]);
                    i.push(o);
                }
                return i.push(this.calculateMidpoint(i[0], i[1])), i.push(this.calculateMidpoint(i[1], i[2])), i.push(this.calculateMidpoint(i[3], i[4])), i[5];
            }),
            (t.prototype.createConnectorPath = function (e, t, i) {
                return (t.type = "none"), this.isSameSameSideConnection(e, t, i) ? this.createSameSideRelationshipPath(e, t, i) : this.createDifferentSideRelationshipPath(e, t, i);
            }),
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.getStyleRules = function (e) {
                return {
                    ".diagram-root": { "font-family": '"Helvetica Neue", sans-serif', "font-size": "12px" },
                    ".t": { overflow: "visible" },
                    ".t-bg": { y: e.table.header.height, fill: e.table.field.background, stroke: e.table.field.border.color, "stroke-width": e.table.field.border.width },
                    ".th": { fill: e.table.header.background, stroke: e.table.header.border.color, "stroke-width": e.table.header.border.width },
                    ".tht": { fill: e.table.header.color, "font-size": "14px", "font-weight": e.table.header.fontWeight },
                    ".tf": { fill: e.table.field.color, overflow: "visible" },
                    ".tf.pk": { fill: e.table.field.pkColor, "font-weight": "bold" },
                    ".tf.fk": { "font-weight": "bold" },
                    ".ty": { fill: e.table.field.typeColor, "font-weight": "normal", "text-anchor": "end" },
                    ".r": { fill: "transparent", stroke: e.relationship.stroke.color, "stroke-width": e.relationship.stroke.width },
                    ".l": { stroke: e.relationship.stroke.width },
                    ".i": { fill: e.table.field.icon.color, stroke: e.table.field.icon.color },
                    ".i.ix": { fill: e.table.field.icon.index.fill, stroke: e.table.field.icon.index.stroke },
                    ".fa": { fill: "transparent", overflow: "visible" },
                    ".fa .bg.hover": { fill: e.table.field.backgroundHover },
                    ".c": { cy: e.port.connector.padding.y, r: e.port.connector.radius, stroke: e.port.connector.color, fill: e.port.connector.color },
                    ".hr": { fill: "transparent", stroke: e.relationship.hover.stroke.color, "stroke-opacity": e.relationship.hover.stroke.opacity, "stroke-width": e.relationship.hover.stroke.width },
                    ".dc": { stroke: e.relationship.delete.circle.color, fill: e.relationship.delete.circle.color },
                    ".x": { stroke: e.relationship.delete.x.color, "stroke-width": e.relationship.delete.x.width },
                    ".hl .th": { fill: e.table.header.highlighting.color },
                    ".hl .tht": { fill: e.table.header.highlighting.textColor },
                    ".fhl .bg": { fill: e.table.field.highlighting.color },
                    ".fhls .bg": { fill: e.table.field.highlighting.softColor },
                    ".r.hl": { stroke: e.relationship.highlighting.color },
                    ".dim": { opacity: 0.25 },
                };
            }),
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.svgLineFactory = function (e, t) {
                return this.svgElementFactory("line", { x1: e.x, y1: e.y, x2: t.x, y2: t.y, class: "l" });
            }),
            (t.prototype.svgRelationshipPathFactory = function (e, t) {
                return this.svgPathFactory(t, { id: e, class: "r" });
            }),
            (t.prototype.svgPkIconFactory = function (e, t, i) {
                var n = { class: "i pk", transform: "translate(" + e + ", " + (t + i.table.field.icon.pk.offset.y) + ")" + " " + ("scale(" + i.table.field.icon.pk.scale + ")") };
                return this.svgPathFactory(this.shapes.keyShape, n);
            }),
            (t.prototype.svgUniqIconFactory = function (e, t, i) {
                var n = { class: "i uq", transform: "translate(" + e + ", " + (t + i.table.field.icon.uniq.offset.y) + ")" + " " + ("scale(" + i.table.field.icon.uniq.scale + ")") };
                return this.svgPathFactory(this.shapes.uniqShape, n);
            }),
            (t.prototype.svgIndexIconFactory = function (e, t, i) {
                var n = { class: "i ix", transform: "translate(" + e + ", " + (t + i.table.field.icon.index.offset.y) + ")" + " " + ("scale(" + i.table.field.icon.index.scale + ")") };
                return this.svgPathFactory(this.shapes.indexShape, n);
            }),
            (t.prototype.svgPathFactory = function (e, t) {
                return this.svgElementFactory("path", _.extend({ d: e }, t));
            }),
            (t.prototype.svgConnectorFactory = function (e, t, i) {
                return this.svgElementFactory("circle", _.extend({ cx: e, class: t }, i));
            }),
            (t.prototype.svgCircleFactory = function (e, t, i, n) {
                var o = _.extend({ cx: e, cy: t, r: i || 5 }, n);
                return o.color && ((o.stroke = o.color), (o.fill = o.color), delete o.color), this.svgElementFactory("circle", o);
            }),
            (t.prototype.svgDeletePathX = function (e, t) {
                var i = { x: e.x - t, y: e.y - t },
                    n = { x: e.x + t, y: e.y + t },
                    o = { x: e.x - t, y: e.y + t },
                    r = { x: e.x + t, y: e.y - t },
                    a = "M" + this.formatPathPoint(i) + " " + this.formatPathPoint(n) + " M" + this.formatPathPoint(o) + " " + this.formatPathPoint(r);
                return this.svgPathFactory(a, { class: "x" });
            }),
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.createTables = function (e, t, i) {
                var n = this,
                    o = this.QRendSvgService.svgGroupFactory({ class: "ts" });
                return (
                    _.each(e.sections.tables, function (e, r) {
                        var a = n.createTable(e, r, t, i);
                        o.appendChild(a);
                    }),
                    o
                );
            }),
            (t.prototype.createTable = function (e, t, i, n) {
                var o = this,
                    r = i.layout[t],
                    a = this.calculateTableWidth(e, i.sharedMetadata, n);
                r.width = a;
                var s = this.QRendSvgService.svgRootFactory({
                    width: a,
                    height: n.table.header.height + 2 * n.table.contentPadding.height + n.table.field.height * _.size(e.fields),
                    x: r.x,
                    y: r.y,
                    ...
                    d = this.createTableHeader(c, a, n);
                _.each(d, function (e) {
                    s.appendChild(e);
                });
                var l = this.createTableBackground(a, _.size(e.fields), n);
                s.appendChild(l);
                var u = 0;
                if (
                    (_.each(e.fields, function (e) {
                        var t = o.createTableField(e, u, i.sharedMetadata, a, n);
                        _.each(t, function (e) {
                    ...
                    var p = this.createEmptyTableField(u, i.sharedMetadata, a, n);
                    _.each(p, function (e) {
                        return s.appendChild(e);
                    }),
                        u++;
            ...
            (t.prototype.createTableHeader = function (e, t, i) {
                return [this.QRendSvgService.svgRectFactory({ height: i.table.header.height, width: t, class: "th" }), this.QRendSvgService.svgPlainTextFactory(e, { x: i.table.header.padding.x, y: i.table.header.padding.y, class: "tht" })];
            }),
            (t.prototype.createTableBackground = function (e, t, i) {
                var n = 2 * i.table.contentPadding.height;
                t = t || 1;
                var o = { height: i.table.field.height * t + n, width: e, class: "t-bg" };
                return i.isSupportedBrowser || (o.y = i.table.header.height), this.QRendSvgService.svgRectFactory(o);
            }),
            (t.prototype.createTableField = function (e, t, i, n, o) {
                var r = o.table.header.height + o.table.contentPadding.height + o.table.field.height * t,
                    a = this.createTableFieldText(e, i, n, r, o),
                    s = this.createTableFieldIcons(e, i, n, r, o);
                return __spreadArrays([a], s);
            }),
            (t.prototype.createEmptyTableField = function (e, t, i, n) {
                var o = { caption: "..." };
                return this.createTableField(o, e, t, i, n);
            }),
            (t.prototype.createTableFieldText = function (e, t, i, n, o) {
                var r = this.QRendUtilsService.getTableFieldNameCaption(e),
                    a = this.QRendSvgService.svgPlainTextFactory(r, { x: o.table.field.padding.x, y: n + o.table.field.padding.y, class: this.getTableFieldCssClass(e) });
                if (e.type) {
                    var s = this.QRendUtilsService.getTableFieldTypeCaption(e, t);
                    a.appendChild(this.QRendSvgService.svgTSpanFactory(s, { x: i - o.table.field.padding.x, class: "ty" }));
                }
                return a;
            }),
            ...
            (t.prototype.createTableFieldIcons = function (e, t, i, n, o) {
                var r = [],
                    a = this.QRendUtilsService.getTableFieldTypeCaption(e, t),
                    s = a ? this.QRendUtilsService.calculateTableFieldTextWidth(a) : 0,
                    c = i - o.table.field.padding.x - s;
                return (
                    e.isPk && ((c -= o.table.field.icon.pk.width), a && (c -= o.table.field.icon.rightOffset), r.push(this.QRendSvgService.svgPkIconFactory(c, n, o))),
                    e.isUniq && ((c -= o.table.field.icon.uniq.width), a && (c -= o.table.field.icon.rightOffset), r.push(this.QRendSvgService.svgUniqIconFactory(c, n, o))),
                    e.isIdx && ((c -= o.table.field.icon.index.width), a && (c -= o.table.field.icon.rightOffset), r.push(this.QRendSvgService.svgIndexIconFactory(c, n, o))),
                    r
                );
            }),
            (t.prototype.calculateTableWidth = function (e, t, i) {
                var n = this.QRendUtilsService.getTableNameCaption(e),
                    o = this.QRendUtilsService.calculateTableHeaderTextWidth(n),
                    r = this.calculateMaxFieldLength(e.fields, t, i),
                    a = 2 * i.table.field.padding.x,
                    s = _.max([i.table.minWidth, o, r]);
            ...
            (t.prototype.calculateMaxFieldLength = function (e, t, i) {
                ...
                return (
                    _.max(
                        _.map(e, function (e) {
                            var o = n.QRendUtilsService.getTableFieldNameCaption(e),
                                r = n.QRendUtilsService.getTableFieldTypeCaption(e, t),
                                a = e.isNullable ? "?" : "",
                                s = n.QRendUtilsService.calculateTableFieldTextWidth(o + r + a);
                            return (
                                e.isPk && ((s += i.table.field.icon.pk.width), r && (s += i.table.field.icon.rightOffset)),
                                e.isUniq && ((s += i.table.field.icon.uniq.width), r && (s += i.table.field.icon.rightOffset)),
                                e.isIdx && ((s += i.table.field.icon.index.width), r && (s += i.table.field.icon.rightOffset)),
                                s
                            );
                        })
            ...
            (t.prototype.createFieldBackground = function (e, t) {
                var i = t.table.header.height + t.table.contentPadding.height + t.table.field.height * e.fieldIndex,
                    n = this.QRendSvgService.svgRootFactory({ width: e.tableWidth, height: t.table.field.height, y: i, class: e.cssClass });
                if ((n.appendChild(this.QRendSvgService.svgRectFactory({ width: e.tableWidth, height: t.table.field.height, class: "bg" })), e.drawConnectors)) {
                    var o = this.createFieldConnectors(e.tableIdentifier, e.fieldIdentifier, e.tableWidth, t);
                    _.each(o, function (e) {
                        n.appendChild(e);
                    });
                }
            ...
            (t.prototype.createFieldConnectors = function (e, t, i, n) {
                var o = "c " + this.QRendUtilsService.createConnectorHtmlClass(e, t),
                    r = { cy: n.port.connector.padding.y, r: n.port.connector.radius };
                return [this.QRendSvgService.svgConnectorFactory(0, o + " l", r), this.QRendSvgService.svgConnectorFactory(i, o + " r", r)];
            }),
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.getSchemaField = function (e, t, i) {
                var n = this.getSchemaTable(e, t);
                return e.sections.settings.isCaseSensitive
                    ? n.fields[i]
                    : _.find(n.fields, function (e, t) {
            ...
            (t.prototype.calculateTextWidth = function (e, t, i) {
                var n = this.get2dCtx();
                return (n.font = i + "px " + t), n.measureText(e).width;
            }),
    ...
    var t = (function () {
        function t(e, t, i, n, o, r, a, s) {
            (this.SourceEditorService = e),
                ...
                (this.QRendTableService = n),
                (this.QRendRelService = o),
                (this.QRendSvgService = r),
                (this.QRendEventService = a),
                (this.QRendEventHighlightService = s);
        }
        return (
            (t.$inject = ["SourceEditorService", "BrowserSupportService", "QRendStyleService", "QRendTableService", "QRendRelService", "QRendSvgService", "QRendEventService", "QRendEventHighlightService"]),
                ...
                this.SourceEditorService.ensureViewportExists(t),
                    ...
                    _.each(e.sections.tables, function (e) {
                        t.sharedMetadata.defaultType &&
                            ...
                            t.layout[e.identifier] || ((t.layout[e.identifier] = { x: i.layout.nonExisting.padding + n * i.layout.nonExisting.width, y: i.layout.nonExisting.padding }), n++);
                    });
            }),
            ...
            (t.prototype.render = function (e, t, i) {
                ...
                o.appendChild(r),
                    ...
                    this.QRendEventService.addEventHandlers(e, t, i, function (e, t) {
                        return n.setDrawingTransformation(e, t);
                    });
            }),
            ...
            (t.prototype.createDiagramRoot = function (e) {
                return this.QRendSvgService.svgRootFactory({ class: "diagram-root", style: "background: " + e.canvas.background, xmlns: "http://www.w3.org/2000/svg", "xmlns:xlink": "http://www.w3.org/1999/xlink" });
            }),
            (t.prototype.createMainGroup = function (e) {
                var t = this.QRendSvgService.svgGroupFactory({ class: "drawing-wrapper" });
            ...
            (t.prototype.setDrawingTransformation = function (e, t) {
                var i = "translate(" + t.position.x + ", " + t.position.y + ")",
                    n = t.zoom ? "scale(" + t.zoom / 100 + ")" : "";
                e.setAttribute("transform", i + " " + n);
            }),
...
!(function (e) {
    !(function () {
        ...
        (t.$inject = ["$scope", "SidenavService", "SourceEditorService", "SchemaDirService"]), (t = __decorate([e.Controller("QdbdApp.Home", "HomeCtrl")], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
...
!(function (e) {
    !(function () {
        function t(e, t) {
            (this.AccountService = e), (this.MessageScreenService = t), (this.changeEmailModel = {});
        }
        (t.$inject = ["AccountService", "MessageScreenService"]),
            (t.prototype.changeEmail = function () {
                ...
                this.AccountService.changeEmail(this.changeEmailModel).then(function () {
                    var t = { header: "Please confirm your new e-mail", message: "A confirmation e-mail was sent to your new email, after you confirm it your e-mail will be updated." };
...
!(function (e) {
    !(function () {
        function t(e, t) {
            (this.AccountService = e), (this.MessageScreenService = t), (this.changePasswordModel = {});
        }
        (t.$inject = ["AccountService", "MessageScreenService"]),
            (t.prototype.changePassword = function () {
                var e = this;
                this.AccountService.changePassword(this.changePasswordModel).then(function () {
                    var t = { header: "Password changed", message: "Your password has been successfully changed" };
                    e.MessageScreenService.showSuccess(t);
                });
            }),
...
!(function (e) {
    !(function () {
        function t(e, t, i) {
            (this.$state = e), (this.ToastService = t), (this.AccountService = i), this.confirmEmail();
        }
        (t.$inject = ["$state", "ToastService", "AccountService"]),
            (t.prototype.confirmEmail = function () {
                ...
                this.AccountService.confirmEmail(this.$state.params.userId, this.$state.params.token).then(function () {
                    e.ToastService.showInfo("Email confirmed."), e.$state.go("root.standardShrinkable.home");
                });
            }),
...
!(function (e) {
    !(function () {
        function t(e, t) {
            (this.AccountService = e), (this.MessageScreenService = t), (this.forgotPasswordModel = {});
        }
        (t.$inject = ["AccountService", "MessageScreenService"]),
            (t.prototype.forgotPassword = function () {
                var e = this;
                this.AccountService.forgotPassword(this.forgotPasswordModel).then(function () {
                    var t = { header: "Email sent", message: "An email with password reset details has been sent to your email address" };
                    e.MessageScreenService.showSuccess(t);
                });
            }),
...
!(function (e) {
    !(function () {
        function t(e, t, i) {
            (this.$scope = e), (this.ToastService = t), (this.AccountService = i), (this.credentials = {});
        }
...
!(function (e) {
    !(function () {
        function t(e, t, i) {
            (this.$state = e), (this.ToastService = t), (this.AccountService = i), (this.resetPasswordModel = {});
        }
        (t.$inject = ["$state", "ToastService", "AccountService"]),
            (t.prototype.resetPassword = function () {
                var e = this;
                this.AccountService.validatePassword(this.resetPasswordModel.password).isValid &&
                    ((this.resetPasswordModel.userId = this.$state.params.userId),
                        ...
                        this.AccountService.resetPassword(this.resetPasswordModel).then(function () {
                            e.ToastService.showInfo("You are now logged in."), e.$state.go("root.standardShrinkable.home");
                        }));
            }),
...
!(function (e) {
    !(function () {
        function t(e, t, i) {
            (this.$state = e), (this.ToastService = t), (this.AccountService = i), (this.credentials = {});
        }
        (t.$inject = ["$state", "ToastService", "AccountService"]),
            (t.prototype.setEmail = function () {
                var e = this;
                this.AccountService.setEmail(this.credentials).then(function () {
                    e.AccountService.resolveCurrentUser(), e.ToastService.showInfo("Thanks for registering! You are now logged in."), e.$state.go("root.standardShrinkable.home");
                });
            }),
...
!(function (e) {
    !(function () {
        function t(e, t, i, n, o, r, a, s, c, d, l) {
            (this.$rootScope = e),
                (this.$scope = t),
                (this.$state = i),
                (this.$timeout = n),
            ...
            (t.prototype.registerEventListeners = function () {
                ...
                this.$scope.$on("error-message", function (t, i) {
                    ...
                    this.$rootScope.$on("current-user-changed", function () {
                        e.RoutingService.handleAuthRedirects(), e.TrackingService.profitWellTrack(), (e.SchemaDirService.dirTreeState.showSharedDiagrams = !1);
                    }),
                    this.$transitions.onSuccess({}, function (t) {
                        t.from();
                        var i = t.to();
                        e.setPageTitle(i), e.RoutingService.handleAuthRedirects(), e.TrackingService.onRouteChange();
                    });
            }),
        ...
        (t.$inject = ["$scope", "$rootScope", "$state", "$mdDialog", "$timeout", "SchemaService", "SchemaDirService", "SourceEditorService", "CollaboratorsService", "ToastService", "TrackingService"]),
            ...
            (t.prototype.autoExpandTreeItems = function () {
                ...
                if (
                    (_.each(this.dirTree, function (t) {
                        ...
                        !_.find(this.dirTree, { isExpanded: !0 }))
                ) {
            ...
            (t.prototype.onTreeItemClick = function (e) {
                "empty-dir-holder" !== e.itemType &&
                    ("dir" === e.itemType
                        ? (e.isExpanded ? this.SchemaDirService.cache.collapseDir(e.id) : this.SchemaDirService.cache.expandDir(e.id), this.expandTreeItems(e.id, !e.isExpanded))
                        : "file" === e.itemType
            ...
            (t.prototype.renameItem = function (e) {
                ...
                this.$mdDialog.show(i).then(function (i) {
                    if (i) {
                        ("dir" === e.itemType ? t.SchemaDirService.renameDir({ id: e.id, name: i }) : t.SchemaService.renameDiagram({ name: i, shortcode: e.shortCode })).then(function () {
                            t.initializeTree(), t.ToastService.showInfo(("dir" === e.itemType ? "Folder" : "File") + " successfully renamed");
                        });
            ...
            (t.prototype.deleteItem = function (e) {
                var t = this,
                    ...
                    n = "Confirm " + ("dir" === e.itemType ? "folder" : "file") + " deletion",
                    o = "<p>Are you sure you want to delete " + (e.name ? "<em>" + e.name + "</em>" : "this item") + "?</p>";
                "dir" === e.itemType && (o += "<p>Deleting this folder will also delete all files within it.</p>");
                var r = this.$mdDialog.confirm().title(n).htmlContent(o).ok("Yes").cancel("No").clickOutsideToClose(!0);
                this.$mdDialog.show(r).then(function () {
                    i && (t.SourceEditorService.clearLocalShortcode(), t.$rootScope.$broadcast("unload-editor-diagram")),
            ...
            (t.prototype.leaveCollab = function (e) {
                var t = this,
                    ...
                    n = this.$mdDialog.confirm().title("Confirm share leaving").htmlContent(i).ok("Yes").cancel("No").clickOutsideToClose(!0);
                this.$mdDialog.show(n).then(function () {
            ...
            (t.prototype.onDragEnter = function () {
                var e = this;
                return function (t, i) {
                    e.dirTreeState.showSharedDiagrams || (angular.element(".drag-over").removeClass("drag-over"), i.addClass("drag-over"));
                };
            }),
                    ...
                    if (!e.dirTreeState.showSharedDiagrams) {
                        ...
                        i.removeClass("drag-over"),
                            "true" === i.attr("is-droppable-dir")
                                ? (e.SchemaDirService.cache.expandDir(r), e.SchemaService.moveDiagramToDir({ parentId: r, shortcode: o.shortCode }).then(e.initializeTree.bind(e)))
                                : -1 === r && e.ToastService.showWarning("Items can't be moved to 'Unsaved Files'");
                    }
                };
            }),
            (t.prototype.addRootDirectory = function () {
                this.TrackingService.trackNewFolder(), this.SchemaDirService.createDir().then(this.initializeTree.bind(this));
            }),
            ...
            (t.prototype.getDirName = function (e) {
                return _.find(this.dirTree, { id: e, itemType: "dir" }).name;
            }),
            ...
            (t.prototype.getFirstDirId = function () {
                var e = _.find(this.dirTree, { itemType: "dir" });
                return e ? e.id : 0;
            }),
            (t = __decorate([e.Component("QdbdApp.SchemaDir", "dtSchemaDir", { templateUrl: "cache/modules/schema-dir/dt-schema-dir.html", controllerAs: "DtSchemaDirVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        function t(e, t, i, n, o, r, a, s, c) {
            (this.$rootScope = e),
                ...
                (this.dirTreeState = { isOpen: !1, showSharedDiagrams: !1 }),
                (this.EXPANDED_DIR_IDS = "expandedDirIds"),
                (this.expandedDirIds = this.getExpandedDirIds()),
                (this.cache = this.cacheFactory());
        }
        return (
            (t.$inject = ["$rootScope", "$http", "$state", "$q", "$mdDialog", "localStorageService", "BaseHttpService", "ToastService", "SchemaService"]),
            ...
            (t.prototype.createUnsavedDirRoot = function () {
                return { id: -1, itemType: "dir", name: "Unsaved Files", parentId: 0, shortCode: null };
            }),
            (t.prototype.createDir = function () {
                ...
                return (
                    this.$mdDialog.show(i).then(function (i) {
                        var n = e.$http.post("api/v1/diagramDir", { name: i || "New Folder" });
                        n.then(
                            function () {
            ...
            (t.prototype.goToFirstDiagram = function (e) {
                var t = _.find(e, { itemType: "file" });
                t && this.$state.go("root.standardShrinkable.diagram", { shortcode: t.shortCode });
            }),
            (t.prototype.cacheFactory = function () {
                var e = this;
                return {
                    expandDir: function (t) {
                        _.contains(e.expandedDirIds, t) || (e.expandedDirIds.push(t), e.saveExpandedDirIds());
                    },
...
!(function (e) {
    !(function () {
        function t(e, t, i) {
            (this.$scope = e), (this.SchemaService = t), (this.PagingService = i), (this.diagrams = {});
        }
        (t.$inject = ["$scope", "SchemaService", "PagingService"]),
            ...
            (t = __decorate([e.Component("QdbdApp.Schema", "dtSchemaList", { bindings: { filter: "=" }, templateUrl: "cache/modules/schema/dt-schema-list/dt-schema-list.html", controllerAs: "DtSchemaListVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        function t(e, t, i, n, o) {
            (this.$http = e), (this.FileSaver = t), (this.ToastService = i), (this.StreamDownloadService = n), (this.TrackingService = o);
        }
        return (
            (t.$inject = ["$http", "FileSaver", "ToastService", "StreamDownloadService", "TrackingService"]),
            (t.prototype.exportToSQL = function (e, t, i, n, o) {
                var r = this;
                if ((this.TrackingService.trackExportToSql(i), 0 === Object.keys(t.errors).length)) {
                    var a = this.createExportFileName(o);
                    this.$http.post("api/v1/schemaExport/toSql", { shortcode: e, quickDbdSchema: this.convertSchemaToExportModel(t), exportType: i, schemaUrl: n, schemaName: o, fileName: a }).then(function (e) {
                        var t = new Blob([e.data], { type: "text/plain;charset=utf-8" });
                        r.FileSaver.saveAs(t, a + ".sql");
                    });
                } else this.ToastService.showError("Schema continas errors and cannot be exported.");
            }),
            (t.prototype.exportToDoc = function (e, t, i, n, o) {
                if ((this.TrackingService.trackExportToDoc(i), 0 === Object.keys(t.errors).length)) {
                    var r = this.createExportFileName(o);
                    this.StreamDownloadService.downloadPost("api/v1/schemaExport/toDoc", { shortcode: e, quickDbdSchema: this.convertSchemaToExportModel(t), exportType: i, schemaUrl: n, schemaName: o, fileName: r });
                } else this.ToastService.showError("Schema continas errors and cannot be exported.");
            }),
            ...
            (t.prototype.convertSchemaToExportModel = function (e) {
                var t = this,
                    i = { comments: e.sections.comments, tables: _.values(angular.copy(e.sections.tables)), relationships: _.values(angular.copy(e.sections.relationships)) };
                return (
            ...
            (t.prototype.convertRelTableFieldNames = function (e, t) {
                this.convertRelTableFieldName(e, t.table1), this.convertRelTableFieldName(e, t.table2);
            }),
...
!(function (e) {
    var t = (function () {
        ...
        return (
            (t.$inject = ["$q", "$rootScope", "$http", "$timeout", "AccountService", "ToastService", "DialogService", "AppConfig"]),
            ...
            (t.prototype.signInWithCredentials = function () {
                ...
                return this.getFirebaseSignOn().then(function (t) {
                    var i = t.data.user,
                        n = t.data.token,
                        o = firebase.auth().signInWithEmailAndPassword(i, n);
                    return (
                        o.catch(function (t) {
                            return e.onFirebaseSignInError(t);
                        }),
                ...
                if (e && e.message) {
                    ...
                    try {
                        _.isString(t) && (t = JSON.parse(t)),
                            t.error &&
                            "Requests from referer https://www.googleapis.com/ are blocked." === t.error.message &&
                        ...
                        console.log(e), _.isString(t) && this.DialogService.showDialogNotification(t);
                    }
                }
            }),
            ...
            (t.prototype.disposeRefs = function (e) {
                e && (this.disposeFirepad(e.firepad), e.sharedMetadata && e.sharedMetadata.off("value"), e.layout && e.layout.off("value"), e.viewport && e.viewport.off("value"));
            }),
            (t.prototype.disposeFirepad = function (e) {
                e && !e.zombie_ && e.dispose();
            }),
            (t.prototype.editorFactory = function (e, t, i) {
                var n = this.getDiagramReference(t),
                    o = Firepad.fromACE(n, e, { defaultText: i });
                return this.registeerDiagramUnreadableHandler(n, o), this.registerDiagramUnwritableHandler(n), this.registerOnDisconnectHandler(), o;
            }),
            (t.prototype.registeerDiagramUnreadableHandler = function (e, t) {
                ...
                e.on(
                    ...
                    function (e) {
                        t &&
                            !t.zombie_ &&
                            (e && "PERMISSION_DENIED" === e.code ? (i.ToastService.showError("Diagram does not exist."), t.firebaseAdapter_.ready_ && t.setText(""), i.disposeFirepad(t)) : e && i.ToastService.showError(e.message));
                    }
                );
            }),
            ...
            (t.prototype.registerOnDisconnectHandler = function () {
                ...
                this.isDisconnectHandlerInitialized ||
                    this.getConnectionReference().on("value", function (t) {
                        t.val()
                            ? (e.isDisconnectHandlerInitialized && e.DialogService.closDialogNotification(), (e.isDisconnectHandlerInitialized = !0))
                            : e.isDisconnectHandlerInitialized && e.DialogService.showDialogNotification("Uh-oh. We can't connect to our server. Please check your internet connection.");
                    });
            }),
            ...
            (t.prototype.getChildReference = function (e, t, i) {
                var n = this.getRootReference(),
                    o = e + "/" + t;
                return i && (o = o + "/" + i), n.child(o);
            }),
            ...
            (t.prototype.setData = function (e, t, i, n, o) {
                return this.dbSave(e, t, i, "set", n, o);
            }),
            (t.prototype.updateData = function (e, t, i, n, o) {
                return this.dbSave(e, t, i, "update", n, o);
            }),
            (t.prototype.dbSave = function (e, t, i, n, o, r) {
                if (!t || !i || !this.currentUserExists()) return this.$q.resolve();
                var a = this.$q.defer();
                return (
                    (o ? this.getUserChildReference(e, this.getCurrentUserUid(), t) : this.getChildReference(e, t, r))[n](this.clearUndefinedProperties(i), function (e) {
            ...
            (t.prototype.setDiagramSchema = function (e, t) {
                ...
                return (
                    i.setText(t, function (e, t) {
                        i.dispose(), e || !t ? n.reject() : n.resolve();
                    }),
                    n.promise
                );
            }),
            ...
            (t.prototype.removeDiagramLayoutTables = function (e, t) {
                return e && t && 0 !== t.length
                    ? this.getChildReference("diagramLayout", e).transaction(function (e) {
                        return (
                            _.each(t, function (t) {
                                e[t] = null;
                            }),
            ...
            (t.prototype.renameDiagram = function (e) {
                return this.updateData("diagramSharedMetadata", e.shortcode, { name: e.name });
            }),
            (t.prototype.registerOnValueChangedHandler = function (e, t, i, n) {
                var o = this,
                    r = n ? this.getUserChildReference(e, n, t) : this.getChildReference(e, t);
                return (
                    r.on(
                        "value",
                        function (e) {
...
!(function (e) {
    var t = (function () {
        function t(e, t, i, n) {
            (this.$http = e), (this.$q = t), (this.MessageScreenService = i), (this.TrackingService = n);
        }
        return (
            ...
            (t.prototype.onImportFromSql = function (e, t) {
                ...
                if (t.parsedSql) return i.length || this.MessageScreenService.showSuccess({ header: "File successfully imported", message: "Your file has been successfully imported " + n }), this.$q.resolve(t.parsedSql);
                if (((i && i.length) || this.showUnhandledErrorsMessage(e, n), i && i.length)) {
                    var o = _.map(i, function (e) {
                        return o + " Line/Column: " + e.line + "/" + e.column + " - " + e.message + "<br />";
                    }).join("");
                    this.MessageScreenService.showError({ header: "The parser got the following errors", message: o + " " + n });
                }
            ...
            (t.prototype.showUnhandledErrorsMessage = function (e, t) {
                ...
                var n = "Sorry, QuickDBD could not understand your schema file. We have logged this and will investigate it. Please run it against " + i + " database and check it is valid.";
                this.MessageScreenService.showError({ header: "Import unhandled error", message: n });
            }),
...
!(function (e) {
    var t = (function () {
        ...
        return (
            (t.$inject = ["$rootScope", "$http", "$location", "$q", "localStorageService", "SchemaFirebaseService", "SourceEditorService", "AccountService"]),
            ...
            (t.prototype.migrateToFirebase = function () {
                ...
                return this.isMigrationToFirebaseRequired()
                    ? this.AccountService.reAuthenticate()
                        ...
                        .then(function () {
                            e.removeLocalSchemas(), e.SourceEditorService.clearLocalShortcode();
                        })
                ...
                return e && 0 !== e.length
                    ? _.map(e, function (e) {
                        ...
                        if (e.settings) {
                            var n = e.settings,
                                o = i.sharedMetadata;
                            (o.isCaseSensitive = n.isCaseSensitive), (o.defaultType = n.defaultType), (i.viewport = { zoom: n.zoom || 100 }), n.position && (i.viewport.position = angular.copy(n.position));
                        }
            ...
            (t.prototype.backupLocalSchemas = function () {
                ...
                if (this.RUN_DIAGNOSTICS) {
                    var t = _.filter(e, { userId: this.$rootScope.currentUser.userId }),
                        i = _.filter(t, { isDirty: !0 }),
                        n = _.filter(t, { isDirty: !1 }),
                        o = _.filter(e, { userId: 0 });
                    console.log("User's diagrams to backup: " + t.length + " (" + i.length + " dirty, " + n.length + " non-dirty)"),
                        console.log("Anonymous diagrams to backup: " + o.length),
                        console.log("Previous users diagrams to backup: " + (e.length - t.length - o.length));
                }
            ...
            (t.prototype.migrateOwnServerSchemas = function () {
                ...
                return this.$http.get("api/v1/schema/getOwnSchemas").then(function (t) {
                    ...
                    return (
                        e.RUN_DIAGNOSTICS && console.log("Server diagrams to migrate: " + i.length),
            ...
            (t.prototype.updateWithServerShotcodes = function (e, t) {
                _.each(e, function (e) {
                    var i = _.find(t, { legacyShortcode: e.shortcode });
...
!(function (e) {
    var t = (function () {
        function t(e, t, i, n) {
            (this.$rootScope = e), (this.QdbdParserConfig = t), (this.AccountService = i), (this.TrackingService = n), (this.allowedRelTypes = _.map(this.QdbdParserConfig.allowedRelTypes, "symbol"));
        }
        return (
            (t.$inject = ["$rootScope", "QdbdParserConfig", "AccountService", "TrackingService"]),
            ...
            (t.prototype.parseSource = function (e, t, i) {
                ...
                var n = this.tokenizeData(e);
                this.parseSettings(n.settings), this.parseTables(n.tables), this.parseRelationships(), this.parseLayout(n.layout);
                var o = { sections: this.sections, errors: this.errors };
                return t && (t.tableCount = _.size(this.sections.tables) || 0), i && (i.isTableLimitReached = this.isTableLimitReached()), o;
            }),
            (t.prototype.getDefaultQdbdSchema = function () {
                return this.parseSource("");
            }),
            (t.prototype.getToken = function (e, t, i) {
                var n = this.getSection(e, t);
                if (n) {
                    var o = this.splitDataByNewLine(n);
            ...
            (t.prototype.initializeFields = function () {
                (this.sections = { settings: {}, tables: {}, relationships: [], layout: {}, comments: [] }), (this.relParsingQueue = []), (this.errors = {}), (this.isLimitReached = !1);
            }),
            (t.prototype.tokenizeData = function (e) {
                var t = this,
                    ...
                    r = [],
                    a = !1,
                    s = { settings: [], tables: [], relationships: [], layout: [] };
                return (
                    _.each(i, function (e, i) {
                        var c = !_.trimRight(e),
                            d = t.getLineData(e);
                        if ((d.comment ? n.push(d.comment) : c && (a || (t.sections.comments.push.apply(t.sections.comments, n), (n = []))), d.data.match(/\t/g))) {
                            t.addError((i + 1).toString(), "Whitespace expected, tab character found (To untabify the whole document use: Menu -> Edit -> Untabify)");
                        }
                        if ((d.data && (a = !0), !((c && "tables" !== o) || (!c && !d.data)))) {
                            var l = { line: (i + 1).toString(), value: d.data, comments: a && d.data ? n : [] };
                            a && d.data && (n = []);
                            var u = _.startsWith(d.data, "[") && _.endsWith(d.data, "]");
                            if (u) {
                                var p = _.trimLeft(_.trimRight(d.data, "]"), "[").toLowerCase();
                                if (((p = t.replaceSectionAliases(p)), !t.validateSection(p, r, l.line))) return;
                                r.push(p), (o = p);
                            }
                            u || s[o].push(l);
                        }
            ...
            (t.prototype.validateSection = function (e, t, i) {
                var n = this.QdbdParserConfig.schemaSections;
                if (!_.includes(n, e)) return this.addError(i, "Invalid section name '[" + e + "]' (allowed: " + n.join(", ") + ")"), !1;
                if (_.includes(t, e)) return this.addError(i, "Section '[" + e + "]' is already defined"), !1;
                var o = _.takeWhile(n, function (t) {
                    return t !== e;
                }),
                    r = _.difference(t, o);
                return !(r.length > 0) || (this.addError(i, "Section '[" + e + "]' is out of order. It must be defined before: '[" + r.join(", ") + "]'"), !1);
            }),
                ...
                _.each(e, function (e) {
                    ...
                    o
                        ? _.includes(o, " ")
                            ...
                            : r
                                ? t.sections.settings[o]
                                    ? t.addError(e.line, "Setting '" + n + "' already defined")
                                    : (("casesensitive" !== o && "casesensitivity" !== o) || ((o = "casesensitive"), (r = t.parseCaseSensitiveSettingValue(r, e.line))),
                                        "position" === o && (r = t.parsePositionSettingValue(r, e.line)),
                                        "zoom" === o && (r = t.parseZoomSettingValue(r, e.line)),
                                        (t.sections.settings[o] = r))
            ...
            (t.prototype.parseCaseSensitiveSettingValue = function (e, t) {
                var i;
                return "off" === e.toLowerCase() ? (i = !1) : "on" === e.toLowerCase() ? (i = !0) : t && this.addError(t, "Invalid 'CaseSensitive' value (allowed: 'on', 'off')"), i;
            }),
            (t.prototype.parsePositionSettingValue = function (e, t) {
                var i = this.splitTokenByFirstWhitespace(e);
                if (t && 2 !== i.length) this.addError(t, "Position setting requires 2 values (x, y)");
                else {
                    var n = _.trim(i[0]);
                    if (!t || this.isNumeric(n)) {
                        var o = parseInt(n),
                            r = _.trim(i[1]);
                        if (!t || this.isNumeric(r)) return { x: o, y: parseInt(r) };
                        this.addError(t, "Invalid Y coordinate '" + (r || void 0) + "', number expected");
                    } else this.addError(t, "Invalid X coordinate '" + (n || void 0) + "', number expected");
                }
            }),
            (t.prototype.parseZoomSettingValue = function (e, t) {
                var i = parseFloat(e);
                return t && (!this.isNumeric(i) || i < 10 || i > 200) && this.addError(t, "Invalid 'Zoom' value (allowed: number between 10 and 200)"), i;
            }),
            (t.prototype.resolveDefaultSettings = function () {
                _.isBoolean(this.sections.settings.casesensitive) || (this.sections.settings.casesensitive = !1),
                    this.sections.settings.position || (this.sections.settings.position = { x: 0, y: 0 }),
            ...
            (t.prototype.parseTable = function (e) {
                ...
                _.each(e, function (e, o) {
                    if (i.isTableFieldsSeparator(e.value)) return 0 === o && i.addError(e.line, "Table name not defined"), void (n = !0);
                    if (0 !== o) {
                        if (t)
                            if (n) {
            ...
            (t.prototype.parseTableName = function (e) {
                ...
                if (i) {
                    if (!this.sections.tables[i.tableIdentifier]) {
                        if (((this.sections.tables[i.tableIdentifier] = { identifier: i.tableIdentifier, caption: i.tableCaption, fields: {}, aliases: i.tableAliases, line: e.line, comments: e.comments }), this.isTableLimitReached())) {
                            var n = "Table " + _.size(this.sections.tables);
                            (this.sections.tables[i.tableIdentifier].caption = n), this.TrackingService.trackEditor(_.size(this.sections.tables), "TableLimitReached", "table_limit_reached");
                        }
                        return (
                            (this.sections.aliases = this.sections.aliases || {}),
                            _.each(i.tableAliases, function (e, n) {
            ...
            (t.prototype.parseTableNamesAndAliases = function (e) {
                var t = e.value.split(" as "),
                    i = [],
                    n = t[0];
                if (_.contains(n, '"') || (!_.contains(n, " ") && !_.contains(n, "."))) {
                    t.length > 1 && (i = t[1].replace(/ /g, "").split(","));
                    var o = this.unquoteText(n);
                    return { tableIdentifier: this.decimalEncodeText(o), tableCaption: o, tableAliases: i };
                }
            ...
            (t.prototype.parseTableMetadataRelationship = function (e, t) {
                ...
                i.length > 3
                    ...
                    : this.queueRelationshipParsing({ relMember1: e, relationType: 3 === i.length ? i[1] : "-", relMember2: 3 === i.length ? i[2] : i[1], line: t.line });
            }),
            (t.prototype.parseTableField = function (e, t) {
                var i = this.tokenizeFieldLine(t.value);
                if (0 !== i.length) {
                    var n = _.trim(i[0].value),
                        o = this.decimalEncodeText(n),
                        r = this.isTableLimitReached();
                    if (o) {
                        if (this.isTableVirtualField(o)) return { identifier: "qdbdvirtualfield" };
                        for (var a = { identifier: o, caption: r ? "..." : n, line: t.line, comments: t.comments }, s = -1, c = 1; c < i.length; c++) {
                            var d = i[c],
                                l = _.trim(d.value);
                            if (s > -1)
                                if (c === s + 1) {
                                    ...
                                    var u = i[c - 1];
                                    this.queueRelationshipParsing({ relMember1: e + "." + o, relationType: u.value || "-", relMember2: d.encoded || d.value || "", line: t.line }), (s = -1);
                                    continue;
                                }
                            var p = l.toLowerCase();
                            ...
                            else if ("identity" === p || "autoincrement" === p) a.isIdentity = !0;
                            else if (_.startsWith(p, "default=")) a.defaultValue = p.replace("default=", "");
                            else if (a.type) this.addError(t.line, "Unrecognized keyword '" + l + "'");
                            else if (r) a.type = " ";
            ...
            (t.prototype.tokenizeFieldLine = function (e) {
                ...
                for (var t = _.startsWith(e, '"') ? 0 : 1, i = [], n = [], o = [], r = 0 === t ? 1 : 0; r < e.length; r++) {
                    var a = e[r];
                    0 === t
                        ? '"' === a
                            ? (t = 1)
                        ...
                        : 1 === t
                            ? " " === a
                                ? n.length > 0 && (i.push(this.buildTableFieldToken(n, o)), (n = []), (o = []))
                                : '"' === a
                                    ? (t = 2)
                                    : (n.push(a), o.push(a))
                            : 2 === t && ('"' === a ? (t = 1) : (n.push(a), this.isAllowedName(a) || (a = this.decimalEncodeCharacter(a)), o.push(a)));
                }
                return n.length > 0 && i.push(this.buildTableFieldToken(n, o)), i;
            }),
            (t.prototype.buildTableFieldToken = function (e, t) {
                var i = e.join(""),
                    n = t.join(""),
                    o = { value: i };
                return i !== n && (o.encoded = n), o;
            }),
            (t.prototype.setSectionTableField = function (e, t, i) {
                if (t && 0 !== Object.keys(this.sections.tables).length)
                    if (this.sections.tables[e].fields[t.identifier]) this.addError(i, "Table field '" + t.identifier + "' already defined");
                    else {
                        var n = this.sections.tables[e].fields;
                        (t.order = _.size(n)), (n[t.identifier] = t);
                    }
            }),
            ...
            (t.prototype.parseRelationship = function (e) {
                if (this.isRelationshipTypeToken(e.relationType)) {
                    ...
                    if (t && i) {
                        ...
                        var n = { table1: t, table2: i, line: e.line };
                        if ((this.resolveAssociationTypes(n, e.relationType), this.relationshipAlreadyExists(n))) return this.sections.relationships.push(n), n;
                    }
                } else {
                    var o = this.allowedRelTypes.join(", ");
                    this.addError(e.line, "Invalid relationship description (allowed: " + o + ")");
                }
            }),
            ...
            (t.prototype.parseRelationshipToken = function (e, t) {
                ...
                if (i) {
                    ...
                    if (!(n.length > 2)) {
                        var o,
                            r = this.getTable(n[0]);
                        2 === n.length && r && (o = this.getTableField(r, n[1]));
                        var a = r && r.identifier ? r.identifier : n[0],
                            s = r && r.caption ? r.caption : n[0];
                        return { tableIdentifier: a, fieldIdentifier: 2 === n.length ? (o && o.identifier ? o.identifier : n[1]) : "qdbdvirtualfield", tableCaption: s, type: "one", isPk: !1, isFk: !1 };
                    }
            ...
            (t.prototype.resolveRelationshipAliases = function (e) {
                ...
                (this.sections.aliases = this.sections.aliases || {}),
                    _.each(e, function (e) {
                        ...
                        var n = t.getTable(e.tableIdentifier);
                        n && (e.tableIdentifier = n.identifier);
                    });
            }),
            ...
            (t.prototype.relationshipAlreadyExists = function (e) {
                ...
                return i && this.addError(e.line, "Relationship already defined at line " + i.line), !i;
            }),
            ...
            (t.prototype.postProcessRelationship = function (e) {
                ...
                if (t && i) {
                    var n = this.validateRelationshipField(e.table1, t, e.line),
                        o = this.validateRelationshipField(e.table2, i, e.line);
                    n && o && this.resolveRelationshipKeys(e, n, o);
                }
            }),
            ...
            (t.prototype.validateRelationshipField = function (e, t, i) {
                var n;
                {
                    if (e.fieldIdentifier) {
                        if (!(n = this.getTableField(t, e.fieldIdentifier))) {
                            if ("qdbdvirtualfield" !== e.fieldIdentifier) return void this.addError(i, "Invalid relationship, the field '" + e.tableIdentifier + "." + e.fieldIdentifier + "' does not exist");
                            t.fields.qdbdvirtualfield = { identifier: "qdbdvirtualfield", order: _.size(t.fields) };
                        }
                        return n;
                    }
            ...
            (t.prototype.resolveRelationshipKeys = function (e, t, i) {
                this.resolveRelMemberKeys(e.table1, t), this.resolveRelMemberKeys(e.table2, i);
            }),
            (t.prototype.resolveRelMemberKeys = function (e, t) {
                t.isPk ? (e.isPk = !0) : "qdbdvirtualfield" !== t.identifier && ((e.isFk = !0), (t.isFk = !0));
            }),
            ...
            (t.prototype.parseLayout = function (e) {
                ...
                _.each(e, function (e) {
                    ...
                    if (3 === i.length) {
                        var n = i[0],
                            o = t.decimalEncodeText(n);
                        if (o)
                            if (t.getTable(o))
                                if (t.sections.layout[o]) t.addError(e.line, "Layout for '" + n + "' already defined");
                                else {
                                    var r = _.trim(i[1]);
                                    if (t.isNumeric(r)) {
                                        var a = parseFloat(r),
                                            s = _.trim(i[2]);
                                        if (t.isNumeric(s)) {
                                            var c = { identifier: o, x: a, y: parseFloat(s) };
                                            t.sections.layout[c.identifier] = c;
                                        } else t.addError(e.line, "Invalid Y coordinate '" + s + "', number expected");
                                    } else t.addError(e.line, "Invalid X coordinate '" + r + "', number expected");
                                }
                            else t.addError(e.line, "Invalid layout definition name, the table '" + n + "' does not exist");
            ...
            (t.prototype.tokenizeLayoutLine = function (e) {
                if (!_.contains(e, '"')) return this.splitByWhitespaceAndRemoveEmptyStrings(e);
                for (var t = _.startsWith(e, '"') ? 0 : 1, i = [], n = [], o = 0 === t ? 1 : 0; o < e.length; o++) {
                    var r = e[o];
                    0 === t ? ('"' === r ? (t = 1) : n.push(r)) : 1 === t && (" " === r ? n.length > 0 && (i.push(n.join("")), (n = [])) : n.push(r));
                }
                return n.length > 0 && i.push(n.join("")), i;
            }),
            ...
            (t.prototype.getLineData = function (e) {
                if (-1 === e.indexOf("#")) return { data: _.trimRight(e) };
                var t = e.split("#"),
                    i = !1,
                    n = "",
                    o = "";
                return (
                    ...
                    { data: _.trimRight(n), comment: _.trim(o) }
                );
            }),
            ...
            (t.prototype.isTableLimitReached = function () {
                return (
                    !!this.isLimitReached || (!(!this.sections || !this.sections.tables) && !(_.size(this.sections.tables) <= 10) && ((this.isLimitReached = !this.isOwnerProUser() && !this.currentUserHasProAccess()), this.isLimitReached))
                );
            }),
    ...
    e.SchemaParserService = t;
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        function t(e, t, i, n, o, r, a, s, c, d) {
            (this.$rootScope = e),
                (this.$http = t),
                (this.$state = i),
                (this.$q = n),
        ...
        return (
            (t.$inject = ["$rootScope", "$http", "$state", "$q", "$mdDialog", "SchemaFirebaseService", "AccountService", "AppStateService", "BaseHttpService", "ToastService"]),
            ...
            (t.prototype.filterDiagrams = function (e) {
                return this.$http.get("api/v1/diagram/filter", { params: e });
            }),
            (t.prototype.filterUserDiagrams = function (e) {
                return this.$http.get("api/v1/diagram/filterUserDiagrams", { params: e });
            }),
            (t.prototype.transitionToDiagram = function (e) {
                return this.$state.go("root.standardShrinkable.diagram", { shortcode: e }, { location: !0, inherit: !0, relative: this.$state.$current, notify: !1 });
            }),
            (t.prototype.createDiagram = function (e) {
                var t = this;
                return (
                    (e.sharedMetadata && e.sharedMetadata.name) || _.extend(e.sharedMetadata, { name: this.getNewFileName() }),
            ...
            (t.prototype.createNamedDiagramInDir = function (e, t) {
                var i = { sharedMetadata: { name: e, parentId: t } };
            ...
            (t.prototype.createDiagramInDirWithNamePrompt = function (e) {
                var t = this,
                    i = this.$q.defer();
                return (
                    this.isUserAllowedToCreateNewDiagram().then(function (n) {
                        if (!n.data.isAllowed) return t.AccountService.requireSubscription(n.data.message), void i.reject();
                        var o = t.$mdDialog.prompt().title("Enter new file name").placeholder("New Name").ariaLabel("New File Name").initialValue(t.getNewFileName()).ok("Save").cancel("Cancel").clickOutsideToClose(!0);
                        t.$mdDialog.show(o).then(function (n) {
                            var o = t.createNamedDiagramInDir(n, e);
                            i.resolve(o);
                        });
                    }),
                    i.promise
    ...
    !(function () {
        ...
        (t.$inject = ["$rootScope", "$scope", "$timeout", "AccountService", "SourceEditorService", "SchemaDirService", "SidenavService", "TrackingService"]),
            ...
            (t.prototype.showDocs = function (e) {
                this.SidenavService.toggleRightSidenav(), this.TrackingService.trackDocumetation("Main");
            }),
            (t.prototype.save = function () {
                this.AccountService.requireLogin();
            }),
            (t.prototype.flipIsCanvasMouseZoomEnabled = function () {
                this.SourceEditorService.flipIsCanvasMouseZoomEnabled(), (this.isCanvasMouseZoomEnabled = this.SourceEditorService.isCanvasMouseZoomEnabled());
            }),
            ...
            (t = __decorate([e.Component("QdbdApp.SourceEditor", "dtSourceEditorMenu", { templateUrl: "cache/modules/source-editor/dt-source-editor-menu.html", controllerAs: "DtSourceEditorMenuVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        function e(e, t, i, n, o, r, a, s, c, d, l, u, p, h, m, g, v, f, b, S, y, D) {
            (this.$rootScope = e),
                (this.$scope = t),
                (this.$timeout = i),
                (this.$state = n),
                ...
                (this.AppStateService = v),
                (this.AppTourService = f),
        ...
        return (
            ...
            (e.prototype.shouldSaveCurrentDiagram = function () {
                ...
                return !t && i && !i.shortcode && this.AccountService.isUserLoggedIn() && !this.isDefaultDiagramAndUserAlreadyHasDiagrams(i)
            ...
            (e.prototype.disallowCurrentDiagramSaving = function () {
                return this.ToastService.showError("Pro account required to save the diagram you just created before logging in"), !1;
            }),
            ...
            (e.prototype.saveCurrentDiagram = function () {
                ...
                this.DialogService.showDialogNotification(0 === this.$rootScope.currentUser.schemaStats.diagramCount ? "Please wait while we set up your account." : "Please wait while we save your new diagram."),
                    this.SchemaFirebaseService.signIn()
                        ...
                        .then(function (t) {
                            e.$state.go("root.standardShrinkable.diagram", { shortcode: t.shortcode });
                        })
                        .finally(function () {
                            e.$mdDialog.cancel();
                        });
            ...
            (e.prototype.initializeDirective = function () {
                ...
                if (((this.firebaseRefs = {}), (this.diagram = this.AppStateService.diagramFactory()), this.diagram.shortcode)) {
                    if (this.isLegacySchemaRoute()) return void this.$state.go("root.standardShrinkable.diagram", { shortcode: this.diagram.shortcode });
                    this.initializeServerDiagram();
                } else if (this.diagram && this.diagram.schema) {
                    if (this.isDefaultDiagramAndUserAlreadyHasDiagrams(this.diagram)) return void this.goToFirstDirTreeItemOrLoadDefaultDiagram();
                    this.loadCurrentDiagram();
                } else {
                    if (e) return void this.$state.go("root.standardShrinkable.diagram", { shortcode: e });
            ...
            (e.prototype.initializeAceEditor = function () {
                (this.$scope.aceLoaded = this.onAceLoaded.bind(this)), (this.$scope.aceChanged = this.onAceChanged.bind(this));
            }),
            (e.prototype.onAceLoaded = function (e) {
                (this.aceEditor = e),
                    (this.aceEditor.$blockScrolling = 1 / 0),
                    this.aceEditor.setOptions({ maxLines: 1e4, autoScrollEditorIntoView: !0 }),
                    this.aceEditor.resize(!0),
                    this.aceEditor.setValue("", -1),
                    this.AppTourService.initializeTour(),
                    this.aceEditor.commands.addCommand({
                        name: "find",
                        bindKey: { win: "Ctrl-F", mac: "Command-F", sender: "editor|cli" },
                        exec: function () {
                            return !1;
                        },
                        readOnly: !0,
            ...
            (e.prototype.intializeFirePad = function () {
                ...
                t && this.DialogService.showDialogNotification("Please wait while we update your account."),
                    this.SchemaFirebaseService.signIn()
                        ...
                        .then(function () {
                            if (t) return e.$mdDialog.cancel(), void e.goToFirstDirTreeItemOrLoadDefaultDiagram();
                            (e.firebaseRefs.firepad = e.SchemaFirebaseService.editorFactory(e.aceEditor, e.diagram.shortcode)), e.firebaseRefs.firepad.setUserColor(e.getRandomUserColor()), e.intializeFirebaseEventHandlers();
                        })
                        .catch(function (t) {
                            console.log(t),
                                e.$timeout(function () {
            ...
            (e.prototype.onSharedMetadataHandler = function (e, t) {
                e || _.isEqual(this.diagram.sharedMetadata, t) || ((this.diagram.sharedMetadata = t), this.initializeRenderingStage1());
            }),
            (e.prototype.onLayoutHandler = function (e, t) {
                e || _.isEqual(this.diagram.layout, t) || ((this.diagram.layout = t), this.initializeRenderingStage1());
            }),
            (e.prototype.onViewportHandler = function (e, t) {
                e || _.isEqual(this.diagram.viewport, t) || ((this.diagram.viewport = t), this.initializeRenderingStage1());
            }),
                ...
                if (this.diagram) {
                    ...
                    return e
                        ? ".." === e
                            ...
                            : void (
                                (this.isMetadataConversionInProgress && this.SourceEditorService.schemaContainsMetadata(e)) ||
                                ((this.isMetadataConversionInProgress = !1),
                                    ...
                                    this.SourceEditorService.schemaErrorsExist(this.qdbdSchema)
                                        ...
                                        : (this.setPageTitle(), this.initializeRenderingStage2(this.diagram, this.diagramSecurity, this.qdbdSchema)))
                            )
                        : (this.setPageTitle(), this.initializeRenderingStage2(this.diagram, this.diagramSecurity), (this.diagram.schema = ""), void (this.qdbdSchema = this.SchemaParserService.parseSource("")));
                }
            }),
            (e.prototype.initializeRenderingStage2 = function (e, t, i) {
                ...
                this.SourceEditorService.applySchemaMetadataConversion(e, i) && this.onMetadataConversion(e),
                    ...
                    (this.broadcastRenderPromise = this.$timeout(
                        function () {
                            n.aceEditor.getSession().clearAnnotations(),
                                n.broadcastRenderDiagram(e, i),
                                n.autoSave(e),
                                n.profitWellTrack(),
                                n.TrackingService.trackEditor(0, "Keypress", "initialize_rendering"),
                                (n.isRenderingInitialized = !0),
                                (n.updateCausedByInteraction = !1);
                        },
                        this.updateCausedByInteraction ? void 0 : 750
                    ));
            }),
            (e.prototype.onMetadataConversion = function (e) {
                this.AccountService.isUserLoggedIn() && ((this.isMetadataConversionInProgress = !0), this.SchemaFirebaseService.saveDiagramMetadata(e)),
            ...
            (e.prototype.cancelInitializedRendering = function () {
                this.broadcastRenderPromise && (this.$timeout.cancel(this.broadcastRenderPromise), (this.isRenderingInitialized = !1), (this.broadcastRenderPromise = void 0));
            }),
            (e.prototype.rerenderCurrentSchema = function (e) {
                void 0 === e && (e = !1), (this.updateCausedByInteraction = e), this.initializeRenderingStage1();
            }),
            (e.prototype.initializeServerDiagram = function () {
                ...
                t.length > 6
                    ...
                    : this.resolveDiagramSecurity().then(function (t) {
                        _.isEmpty(t)
                            ? (e.ToastService.showError("Diagram does not exist."), e.AccountService.isUserLoggedIn() || (e.SourceEditorService.clearLocalShortcode(), e.$state.go("root.standardShrinkable.home")))
                            : e.intializeFirePad();
                    });
            }),
            (e.prototype.resolveShorterShortcodeRoute = function (e) {
                ...
                this.SchemaService.getShortcode(e).then(function (e) {
                    e.data ? t.$state.go("root.standardShrinkable.diagram", { shortcode: e.data }) : t.ToastService.showError("Diagram does not exist.");
                });
            }),
            ...
            (e.prototype.loadCurrentDiagram = function () {
                this.loadSchema(this.diagram.schema), this.AccountService.isUserLoggedIn() && !this.$rootScope.currentUser.hasProAccess && this.$rootScope.currentUser.schemaStats.diagramCount > 0 && this.aceEditor.setReadOnly(!0);
            }),
            (e.prototype.goToFirstDirTreeItemOrLoadDefaultDiagram = function () {
                var e = this;
                this.SchemaDirService.getFirstDirDiagram().then(function (t) {
                    t ? e.$state.go("root.standardShrinkable.diagram", { shortcode: t.shortCode }, { reload: !0 }) : e.loadDefaultDiagram();
                });
            }),
            (e.prototype.loadDefaultDiagram = function () {
                this.SourceEditorService.isDemoInitialized() ? this.loadSchema("") : (this.loadDemoSchema(), this.SourceEditorService.flagDemoAsInitialized());
            }),
            ...
            (e.prototype.handleSchemaErrors = function (e, t) {
                ...
                this.aceEditor.getSession().setAnnotations(i), this.broadcastDiagramChanged(e, t);
            }),
            (e.prototype.onDiagramDragged = function (e, t) {
                var i = this;
                this.delayInteraction(function () {
                    i.SourceEditorService.setViewportPosition(i.diagram, t.x, t.y), i.SchemaFirebaseService.setDiagramViewport(i.diagram.shortcode, i.diagram.viewport);
                });
            }),
            ...
            (e.prototype.onDiagramTableMoved = function (e, t, i) {
                var n = this;
                this.delayInteraction(function () {
                    n.SourceEditorService.purgeParentlessLayoutTables(n.diagram, n.qdbdSchema), n.SourceEditorService.ensureLayoutExists(n.diagram);
                    var e = { x: t.x, y: t.y };
                    n.SourceEditorService.updateTablePosition(n.diagram, i, e), n.SchemaFirebaseService.setDiagramLayoutTable(n.diagram.shortcode, i, e);
                });
            }),
                ...
                this.diagramSecurity && this.diagramSecurity.isLockedForEditing
                    ...
                    : this.delayInteraction(function () {
                        ...
                        var e = parseInt(t.fromLine) - 1,
                            n = i.aceEditor.session.getLine(e),
                            o = i.SourceEditorService.addRelationshipToLine(n, t);
                        i.updateAceLine(e, o);
                    });
            }),
            (e.prototype.onDiagramLinkRemoved = function (e, t) {
                ...
                this.diagramSecurity && this.diagramSecurity.isLockedForEditing
                    ...
                    : this.delayInteraction(function () {
                        ...
                        var e = t - 1,
                            n = i.aceEditor.session.getLine(e),
                            o = i.SourceEditorService.removeRelationshipFromLine(n, t);
                        o ? i.updateAceLine(e, o) : i.removeAceLine(e);
                    });
            }),
            (e.prototype.centerDiagram = function (e, t) {
                this.SourceEditorService.setViewportPosition(this.diagram, 0, 0), t && this.rerenderCurrentSchema(!0), this.SchemaFirebaseService.setDiagramViewport(this.diagram.shortcode, this.diagram.viewport);
            }),
            (e.prototype.onDiagramZoomSet = function (e, t, i) {
                this.SourceEditorService.resolveZoomLevel(this.diagram, t), i && this.rerenderCurrentSchema(!0), this.SchemaFirebaseService.setDiagramViewport(this.diagram.shortcode, this.diagram.viewport);
            }),
            (e.prototype.onDiagramViewportSet = function (e, t, i) {
                this.SourceEditorService.setViewport(this.diagram, t), i && this.rerenderCurrentSchema(!0), this.SchemaFirebaseService.setDiagramViewport(this.diagram.shortcode, this.diagram.viewport);
            }),
            ...
            (e.prototype.registerMenuActionListener = function () {
                var e = this;
                this.$scope.$on("editor-menu-action", function (t, i, n) {
                    e[i] && e[i](n);
                });
            }),
            (e.prototype.rename = function () {
                ...
                this.$mdDialog.show(t).then(function (t) {
                    t ? (e.SchemaService.renameDiagram({ name: t, shortcode: e.diagram.shortcode }), e.broadcastDiagramChanged(e.diagram, e.qdbdSchema)) : e.ToastService.showWarning("Empty names not allowed");
                });
            }),
            (e.prototype.copyCurrentDiagram = function () {
                ...
                this.AccountService.requireLogin() ||
                    ...
                    this.SchemaService.createDiagram(this.diagram).then(function (t) {
                        _.extend(e.diagram, t), e.onSchemaSaved(e.diagram.shortcode), e.ToastService.showInfo("Diagram copied successfully.");
                    });
            }),
            (e.prototype.share = function () {
                this.AccountService.requireLogin() || (this.TrackingService.trackShare("LINK"), this.showShortcode(this.getUrlShortcode()));
            }),
            (e.prototype.onSchemaSaved = function (e) {
                this.SchemaService.transitionToDiagram(e), this.SourceEditorService.setLocalShortcode(e), this.setPageTitle(), this.broadcastDiagramChanged(this.diagram, this.qdbdSchema);
            }),
            ...
            (e.prototype.flipPrivate = function () {
                ...
                if (!this.AccountService.requireSubscription()) {
                    var t = this.$mdDialog
                        .confirm()
                        .title(this.diagramSecurity.isPrivate ? "Make public" : "Make private")
                        .htmlContent("<p>Are you sure you want to change the privacy of the diagram?</p>")
                        .ok("Yes")
                        .cancel("No")
                        .clickOutsideToClose(!0);
            ...
            (e.prototype.demo = function () {
                var e = this.SourceEditorService.getDemoSample();
                this.aceEditor.setValue(e, -1), this.TrackingService.trackEditor(0, "Reset", "reset");
            }),
            ...
            (e.prototype.importFromSQL = function (e) {
                var t,
                    i = this;
                ((t = document.getElementById("import-file-input")).onchange = function (n) {
            ...
            (e.prototype.unloadDiagram = function () {
                this.SchemaFirebaseService.disposeRefs(this.firebaseRefs), (this.diagram = void 0);
            }),
            ...
            (e.prototype.getParsingStatus = function () {
                return (
                    this.broadcastRenderPromise && 0 === this.broadcastRenderPromise.$$state.status && !this.updateCausedByInteraction
                        ? (this.parsingStatus = "loading")
                        : this.SourceEditorService.schemaErrorsExist(this.qdbdSchema)
            ...
            (e.prototype.updateAceLine = function (e, t, i) {
                void 0 === i && (i = !0), this.aceEditor.session.replace({ start: { row: e, column: 0 }, end: { row: e, column: Number.MAX_VALUE } }, t), i && this.goToLine(e + 1);
            }),
            (e.prototype.removeAceLine = function (e) {
                this.aceEditor.session.replace({ start: { row: e - 1, column: Number.MAX_VALUE }, end: { row: e, column: Number.MAX_VALUE } }, "");
            }),
            (e.prototype.goToLine = function (e) {
                this.aceEditor.resize(!0), this.aceEditor.gotoLine(e, Number.MAX_VALUE), this.aceEditor.focus();
            }),
            ...
            (e.prototype.getDiagramLockedReason = function () {
                if (this.diagramSecurity && this.diagramSecurity.isLockedForEditing) {
                    if (!this.AccountService.isUserLoggedIn()) return "Login to edit this diagram.";
                    if (!this.diagramSecurity.isOwnedByCurrentUser) return "This diagram is in read-only mode for you because the owner does not have Pro access. Click to copy and enable editing.";
                    if (this.diagramSecurity.requireProAccess) return "Go Pro to edit this diagram.";
                }
                return "Diagram locked for editing.";
            }),
            (e.prototype.onLockButtonClick = function () {
                if (this.diagramSecurity && this.diagramSecurity.isLockedForEditing) {
                    if (!this.AccountService.isUserLoggedIn()) return void this.$state.go("root.centered.login");
                    if (!this.diagramSecurity.isOwnedByCurrentUser) return void this.copyCurrentDiagram();
                    if (this.diagramSecurity.requireProAccess) return void this.$state.go("root.centered.subscribe");
                }
            }),
            ...
            (e.prototype.broadcastRenderDiagram = function (e, t) {
                this.$rootScope.$broadcast("render-diagram", e, t), this.broadcastDiagramChanged(e, t);
            }),
            (e.prototype.autoSave = function (e) {
                this.lastAutoSaveAt
                    ...
                    ((this.lastAutoSaveAt = moment()),
                        ...
                        this.diagram.sharedMetadata && !this.diagramSecurity.isLockedForEditing && this.SchemaFirebaseService.setDiagramSharedMetadata(this.diagram.shortcode, this.diagram.sharedMetadata))
                    : (this.lastAutoSaveAt = moment());
            }),
            (e.prototype.profitWellTrack = function () {
                this.lastProfitWellAt ? this.lastProfitWellAt.isAfter(moment().add(-1, "hours")) || ((this.lastProfitWellAt = moment()), this.TrackingService.profitWellTrack()) : (this.lastProfitWellAt = moment());
            }),
    ...
    angular
        ...
        .directive("dtSourceEditor", function () {
            return { restrict: "E", templateUrl: "cache/modules/source-editor/dt-source-editor.html" };
        });
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    var t = (function () {
        ...
        return (
            (t.$inject = ["$rootScope", "$state", "$http", "$mdDialog", "localStorageService", "SchemaParserService", "SchemaFirebaseService", "AccountService", "ToastService"]),
            ...
            (t.prototype.ensureViewportExists = function (e) {
                ...
                (void 0 !== t && null !== t) || (e.viewport.position = { x: 0, y: 0 });
            ...
            (t.prototype.setViewportPosition = function (e, t, i) {
                this.ensureViewportExists(e), _.extend(e.viewport.position, { x: t, y: i });
            }),
            ...
            (t.prototype.resolveZoomDiff = function (e, t) {
                this.ensureViewportExists(e), (e.viewport.zoom = this.resolveZoomDiffValue(e.viewport.zoom, t));
            }),
            ...
            (t.prototype.addRelationshipToLine = function (e, t) {
                ...
                if (this.SchemaParserService.isValidLine(parseInt(t.fromLine))) return this.ToastService.showError("Could not create relationship, found error on line " + t.fromLine + "."), e;
                var i = "FK >- " + this.createRelDefinitionSegment(t.toTable) + "." + this.createRelDefinitionSegment(t.toField),
                    n = this.stripExtraWhitespace(e),
                    o = n.split(" "),
                    r = _.findIndex(o, function (e) {
                        return "fk" === e.toLowerCase();
                    });
                if (-1 === r) n = n + " " + i;
                else {
                    var a = this.SchemaParserService.containsRelationshipType(o) ? 3 : 1,
                        s = o.slice(r, r + a).join(" ");
                    n = n.replace(s, i);
                }
                return n;
            }),
            ...
            (t.prototype.removeRelationshipFromLine = function (e, t) {
                if (this.SchemaParserService.isValidLine(t)) return this.ToastService.showError("Could not create relationship, found error on line " + t + "."), e;
                if (_.startsWith(e, "rel ") && !_.contains(e.toLowerCase(), "fk")) return "";
                var i = e.split(" "),
                    n = _.findIndex(i, function (e) {
                        return "fk" === e.toLowerCase();
                    });
                return i.splice(n, 3), i.join(" ");
            }),
            (t.prototype.createAceErrors = function (e) {
                return _.map(e, function (e, t) {
                    return { row: parseInt(t) - 1, text: e.join("\r\n"), type: "error" };
                });
            }),
            ...
            (t.prototype.applySchemaMetadataConversion = function (e, t) {
                ...
                if (t.sections && t.sections.settings) {
                    var n = t.sections.settings;
                    this.ensureSharedMetadataExists(e),
                        this.ensureViewportExists(e),
                        _.extend(e.sharedMetadata, { isCaseSensitive: n.casesensitive, defaultType: n.defaultfieldtype }),
                        _.extend(e.viewport, { zoom: n.zoom, position: n.position });
                }
                return (
                    t.sections &&
                    t.sections.layout &&
                    (this.ensureLayoutExists(e),
                        _.each(t.sections.layout, function (t, n) {
                            i.updateTablePosition(e, n, { x: t.x, y: t.y });
                        })),
            ...
            (t.prototype.purgeParentlessLayoutTables = function (e, t) {
                if (t && t.sections) {
                    var i = _.map(t.sections.tables, "identifier"),
                        n = this.removeNonExistingLayoutTables(e.layout, i);
                    n.length > 0 && this.SchemaFirebaseService.removeDiagramLayoutTables(e.shortcode, n);
                }
            }),
            ...
            (t.prototype.metadataConversionNotification = function (e) {
                ...
                this.isDemoSampleWithoutMeta(e.schema) ||
                    (this.localStorageService.get(this.CONVERSION_NOTIFICATION_KEY)
                        ? this.ToastService.showInfoWithAction("Diagram format updated", "INFO", function () {
                            return t.showMetadataConversionModal();
                        })
                        : (this.localStorageService.set(this.CONVERSION_NOTIFICATION_KEY, !0), this.showMetadataConversionModal()));
            }),
...
!(function (e) {
    !(function () {
        ...
        (t.$inject = ["$rootScope", "$scope", "$state", "$timeout", "SubscriptionService", "AccountService", "ToastService", "CountryCodesService"]),
            (t.prototype.initialize = function () {
                var e = this.SubscriptionService.initializeBillingDetails();
                (this.billingDetails = e),
                    (this.countryCodes = this.CountryCodesService.codes),
            ...
            (t.prototype.confirmEmail = function () {
                ...
                this.AccountService.requestEmailConfirmation().then(function () {
                    e.ToastService.showInfo("Confirmation email sent"), e.$state.go("root.standard.user.profile", { userId: e.$rootScope.currentUser.userId });
                });
            }),
            (t.prototype.confirmBillingDetails = function () {
                ...
                this.SubscriptionService.updateBillingDetails(this.billingDetails).then(
                    function () {
                        e.SubscriptionService.setBillingDetails(e.billingDetails), e.SubscriptionService.cacheVoucherCodeChoice(e.billingDetails.voucherCode), e.$state.go("root.centered.checkout");
                    },
                    function () {
...
!(function (e) {
    !(function () {
        ...
        (t.$inject = ["$scope", "$rootScope", "$log", "$timeout", "SubscriptionService", "MessageScreenService", "ToastService", "ErrorService", "TrackingService", "$state"]),
            (t.prototype.initialize = function () {
                var e = this;
                this.SubscriptionService.getBillingDetails()
                    ? this.SubscriptionService.getCheckoutDetails()
                        .then(function (t) {
                            return (e.checkoutDetails = t.data), (e.isVoucher = "voucher" === e.checkoutDetails.plan), e.SubscriptionService.getToken();
                        })
                        .then(
                            function (t) {
                                var i = t.data;
                            ...
                            function (t) {
                                t.data.modelState["model.DiscountCode"] && t.data.modelState["model.DiscountCode"].length > 0
                                    ? (e.SubscriptionService.clearDiscountCached(), e.ToastService.showError(t.data.modelState["model.DiscountCode"][0]), e.back())
                                    : e.showErrorToast();
                            }
                        )
            ...
            (t.prototype.initializeDropin = function (e) {
                ...
                (this.braintreeInitStarted = !0),
                    ...
                    braintree.dropin.create({ authorization: e, container: "#dropin-container", paypal: { flow: "vault" }, threeDSecure: !0 }, function (e, i) {
                        t.$timeout(function () {
                            e ? (t.ErrorService.logError(e), t.showErrorToast()) : t.initializeDropinInstance(i);
                        });
                    });
            }),
            (t.prototype.initializeDropinInstance = function (e) {
                ...
                (this.dropInInstance = e),
                    ...
                    this.dropInInstance.on("paymentMethodRequestable", function (e) {
                        t.$timeout(function () {
                            (t.isMethodSelectable = t.isPaymentMethodSelectable(e)), t.isMethodSelectable ? (t.isMethodSelected = !1) : (t.isMethodSelected = !!t.getActivePaymentMethod());
                        });
                    }),
            ...
            (t.prototype.getActivePaymentMethod = function () {
                if (this.dropInInstance && this.dropInInstance._model && this.dropInInstance._model._activePaymentMethod) return this.dropInInstance._model._activePaymentMethod;
            }),
            (t.prototype.selectPaymentMethod = function () {
                var e = this;
                this.dropInInstance.requestPaymentMethod({ threeDSecure: this.get3dSecure() }, function (t, i) {
                    e.$timeout(function () {
                        t ? (e.ErrorService.logError(t), e.showErrorToast()) : ((e.isMethodSelectable = !1), (e.isMethodSelected = !!e.getActivePaymentMethod()));
                    });
                });
            }),
            (t.prototype.get3dSecure = function () {
                var e = this.SubscriptionService.getBillingDetails();
                return {
                    amount: this.checkoutDetails.amountToPay,
                    email: this.$rootScope.currentUser.email,
                    billingAddress: { givenName: e.firstName, surname: e.lastName, streetAddress: e.address, postalCode: e.postCode, countryCodeAlpha2: e.countryCode },
                };
            }),
                    ...
                    this.SubscriptionService.subscribe(t).then(
                        function () {
                            e.TrackingService.trackPurchase(e.checkoutDetails.amountToPay, e.checkoutDetails.planCaption.split(" ")[0]),
                                e.SubscriptionService.clearBillingDetails(),
                                e.MessageScreenService.showSuccess({ header: "Payment successful!", message: "Thank you! You have successfuly subscribed to QuickDBD." });
                        },
                        function () {
            ...
            (t.prototype.showErrorContactUsPage = function () {
                this.MessageScreenService.showError({ header: "Payment failed", message: "Sorry, something went wrong during the payment process. Please contact us at info@dovetail.ie and we'll sort it out for you." });
            }),
            (t.prototype.back = function () {
                this.$state.go("root.centered.billingDetails");
            }),
...
!(function (e) {
    var t = (function () {
        ...
        return (t = __decorate([e.Service("QdbdApp.Subscription", "CountryCodesService")], t));
    })();
    e.CountryCodesService = t;
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        function t(e, t, i, n) {
            (this.$rootScope = e),
                ...
                (this.ToastService = n),
                (this.model = { reasonId: "price" }),
                (this.reasons = {
                    price: { id: "price", reason: "The price is too high", question: "How much would you be willing to pay for it?" },
                    otherProduct: { id: "otherProduct", reason: "I decided to use another product", question: "Could you please share with us which one?" },
                    other: { id: "other", reason: "Other", question: "Could you please tell us why?" },
                    dontNeedIt: { id: "dontNeedIt", reason: "I don't need it anymore", question: "Any additional comments?" },
                    didntWork: { id: "didntWork", reason: "The product did not work as expected", question: "Could you please provide us with some details?" },
                    missingFeatures: { id: "missingFeatures", reason: "Some features that I need are missing", question: "Could you please tell us which ones?" },
                });
        }
            ...
            (t.prototype.confirm = function () {
                ...
                (this.model.reason = this.reasons[this.model.reasonId].reason),
                    this.SubscriptionService.cancelSubscription(this.model).then(function () {
                        e.$rootScope.$broadcast("subscription-cancelled"), e.ToastService.showInfo("Successfully unsubscribed"), e.close();
                    });
            }),
            (t = __decorate(
                [
                ...
                this.$state.current.url.toString().indexOf("voucher") >= 0
                    ...
                    : this.$state.current.url.toString().indexOf("discount") >= 0
                        ...
                        : this.AccountService.reAuthenticate().then(function () {
                            a.SubscriptionService.ensureUserNotSubscribed(), !a.$rootScope.currentUser.hasProAccess && a.SubscriptionService.hasVoucherCode() && a.selectSubscription("voucher");
                        });
        }
        (t.$inject = ["$rootScope", "$state", "AccountService", "SubscriptionService", "SharingService", "MessageScreenService"]),
            (t.prototype.parseDiscountURL = function () {
                ...
                this.$state.params &&
                    ...
                    (this.SubscriptionService.cacheDiscountCodeChoice(this.$state.params.discountCode),
            ...
            (t.prototype.parseVoucherURL = function () {
                if (this.$state.params && this.$state.params.voucherCode) {
                    ...
                    this.MessageScreenService.showSuccess({ header: "Voucher recorded successfully!", message: e });
                }
            }),
            ...
            (t.prototype.selectSubscription = function (e) {
                this.SubscriptionService.cacheSubscriptionChoice(e), this.$state.go("root.centered.billingDetails");
            }),
...
!(function (e) {
    var t = (function () {
        ...
        return (
            (t.$inject = ["$rootScope", "$http", "localStorageService", "BaseHttpService", "AccountService", "MessageScreenService"]),
            (t.prototype.ensureUserNotSubscribed = function () {
                this.$rootScope.currentUser && this.$rootScope.currentUser.activeSubscription && this.MessageScreenService.showError({ header: "Subscription exists", message: "You already have an active subscription." });
            }),
            ...
            (t.prototype.subscribe = function (e) {
                ...
                return (
                    i.then(function () {
                        t.AccountService.reAuthenticate(), t.cacheVoucherCodeChoice(""), t.clearDiscountCached();
                    }),
                    i
                );
            }),
            ...
            (t.prototype.initializeBillingDetails = function () {
            ...
            (t.prototype.setBillingDetails = function (e) {
                this.billingDetails = e;
            }),
            (t.prototype.clearBillingDetails = function () {
            ...
            (t.prototype.getCheckoutDetails = function () {
                ...
                return (null !== t && void 0 !== t && "" !== t) || (t = e), (null !== i && void 0 !== i && "" !== i) || (i = e), this.$http.get("api/v1/payment/checkoutDetails/" + e + "/" + t + "/" + i);
            }),
            (t.prototype.grantProAccess = function (e, t) {
                return this.$http.post("api/v1/user/grantProAccess", { userId: e, grantType: t });
            }),
...
!(function (e) {
    !(function () {
        ...
        (t.$inject = ["$scope", "SchemaService", "PagingService"]),
            ...
            (t = __decorate([e.Component("QdbdApp.SourceEditor", "dtUserDiagrams", { bindings: { filter: "=" }, templateUrl: "cache/modules/user/dt-user-diagrams/dt-user-diagrams.html", controllerAs: "DtUserDiagramsVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        function t(e, t, i, n) {
            (this.$scope = e), (this.UserService = t), (this.ToastService = i), (this.PagingService = n), (this.users = {});
        }
        (t.$inject = ["$scope", "UserService", "ToastService", "PagingService"]),
            (t.prototype.$onInit = function () {
                (this.pager = this.PagingService.pagerFactory(this.filter, this.users, this.loadUsers.bind(this), "root.standard.admin.userList")), this.$scope.$watch("DtUserListVM.filter", this.pager.onFilterChanged.bind(this), !0);
            }),
            ...
            (t = __decorate([e.Component("QdbdApp.User", "dtUserList", { bindings: { filter: "=" }, templateUrl: "cache/modules/user/dt-user-list/dt-user-list.html", controllerAs: "DtUserListVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        ...
        (t.$inject = ["SubscriptionService"]),
            ...
            (t = __decorate([e.Component("QdbdApp.User", "dtUserPayments", { bindings: { userId: "=" }, templateUrl: "cache/modules/user/dt-user-payments/dt-user-payments.html", controllerAs: "DtUserPaymentsVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        function t(e, t, i, n, o, r, a) {
            (this.$rootScope = e), (this.$mdDialog = t), (this.$state = i), (this.AccountService = n), (this.UserService = o), (this.SubscriptionService = r), (this.ToastService = a);
        }
        (t.$inject = ["$rootScope", "$mdDialog", "$state", "AccountService", "UserService", "SubscriptionService", "ToastService"]),
            ...
            (t.prototype.initializeFilter = function () {
                this.filter = { page: 1, pageSize: 5, sortBy: "name", ownerId: this.userProfile ? this.userProfile.userId : null };
            }),
            (t.prototype.grantProAccess = function (e) {
                ...
                this.$mdDialog.show(i).then(function () {
                    t.SubscriptionService.grantProAccess(t.userProfile.userId, e).then(function () {
                        t.ToastService.showInfo("Pro access granted"), t.initializeUser && t.initializeUser(), t.AccountService.reAuthenticateIfCurrentUser(t.userProfile.userId);
                    });
                });
            }),
            (t.prototype.removeSubscription = function () {
                ...
                this.$mdDialog.show(t).then(function () {
                    e.SubscriptionService.removeSubscription(e.userProfile.userId).then(function () {
                        e.ToastService.showInfo("Subscription removed"), e.initializeUser && e.initializeUser(), e.AccountService.reAuthenticateIfCurrentUser(e.userProfile.userId);
                    });
                });
            }),
            ...
            (t.prototype.deleteUser = function (e) {
                ...
                this.$mdDialog.show(i).then(function () {
                    t.UserService.deleteUser(e).then(function () {
                        t.ToastService.showInfo("Account Deleted"), t.$rootScope.currentUser.userId === e ? t.AccountService.logout() : t.$state.go("root.standard.admin.userList");
                    });
                });
            }),
            (t = __decorate(
                [e.Component("QdbdApp.User", "dtUserProfile", { bindings: { userProfile: "=", initializeUser: "&" }, templateUrl: "cache/modules/user/dt-user-profile/dt-user-profile.html", controllerAs: "DtUserProfileVM" })],
                t
            ));
    })();
})(QdbdApp || (QdbdApp = {}));
    ...
    !(function () {
        ...
        (t.$inject = ["$scope", "$state", "UserService"]),
            (t.prototype.initializeUser = function () {
                ...
                e
                    ? this.UserService.getUserProfile(e).then(this.onProfileFetched.bind(this), this.onProfileFetchError.bind(this))
                    : this.UserService.getCurrentUserProfile().then(this.onProfileFetched.bind(this), this.onProfileFetchError.bind(this));
            }),
...
!(function (e) {
    !(function () {
        function t(e, t, i, n) {
            (this.$rootScope = e), (this.$state = t), (this.$timeout = i), (this.TrackingService = n), this.setupRoutes(), this.handleRouting(), this.initializeFilter();
        }
        (t.$inject = ["$rootScope", "$state", "$timeout", "TrackingService"]),
            (t.prototype.setupRoutes = function () {
                ...
                (this.userId = this.$state.params.userId),
                    (this.routes = [
                        { caption: "Profile", name: "root.standard.user.profile" },
                        { caption: "Diagrams", name: "root.standard.user.diagrams" },
                        { caption: "Payments", name: "root.standard.user.payments" },
                    ]),
                    this.$timeout(function () {
                        e.selectedTab = _.findIndex(e.routes, { name: e.$state.current.name });
                    });
            ...
            (t.prototype.handleRouting = function () {
                this.$state.is("root.standard.user") && this.$state.go("root.standard.user.profile", { userId: this.$rootScope.currentUser.userId });
            }),
            (t.prototype.initializeFilter = function () {
                this.filter = {
            ...
            (t.prototype.loadRoute = function (e) {
                ...
                this.TrackingService.trackAccount(n);
            }),
    ...
    var t = (function () {
        ...
        return (
            ...
            (t.prototype.filterUsers = function (e) {
                return this.$http.get("api/v1/user/filter", { params: e });
            }),
...
!(function (e) {
    !(function () {
        function t(e, t, i, n, o, r, a) {
            (this.$scope = e), (this.VoucherService = t), (this.$state = i), (this.PagingService = n), (this.ToastService = o), (this.$window = r), (this.$location = a), (this.vouchers = {});
        }
        (t.$inject = ["$scope", "VoucherService", "$state", "PagingService", "ToastService", "$window", "$location"]),
            ...
            (t.prototype.editNewVoucher = function (e) {
                this.$state.go("root.standard.admin.voucher", { voucher: e });
            }),
            (t.prototype.copyVoucherUrl = function (e) {
                this.VoucherService.copyVoucherUrl(e);
            }),
            (t = __decorate([e.Component("QdbdApp.Voucher", "dtVoucherList", { bindings: { filter: "=" }, templateUrl: "cache/modules/voucher/dt-voucher-list/dt-voucher-list.html", controllerAs: "DtVoucherListVM" })], t));
    })();
})(QdbdApp || (QdbdApp = {}));
var QdbdApp;
!(function (e) {
    !(function () {
        function t(e, t, i, n) {
            (this.$state = e), (this.$scope = t), (this.VoucherService = i), (this.ToastService = n), (this.voucher = {}), (this.isEdit = !1);
            var o = this.$state.params.voucher;
            null === o
                ? ((this.voucher.maxRedemptions = 1), (this.voucher.valueInWeeks = 4), (this.voucher.minDate = new Date()), (this.voucher.validFrom = new Date()), this.voucher.validFrom.setHours(0, 0, 0, 0), (this.isEdit = !1))
                : ((this.voucher = o),
        ...
        (t.$inject = ["$state", "$scope", "VoucherService", "ToastService"]),
            ...
            (t.prototype.save = function () {
                ...
                this.VoucherService.save(this.voucher).then(
                    ...
                    function (t) {
                        (e.voucher.modelState = t.data.modelState), t.data && t.data.error_description && ((e.voucher.modelState = {}), (e.voucher.modelState[""] = [t.data.error_description]));
                    }
                );
            }),
            (t.prototype.setDefaultPeriod = function (e) {
                switch (e) {
                    case "week":
                        (this.voucher.validFrom = new Date()), (this.voucher.validTo = new Date()), this.voucher.validTo.setDate(this.voucher.validTo.getDate() + 7);
                        break;
                    case "month":
                        (this.voucher.validFrom = new Date()), (this.voucher.validTo = new Date()), this.voucher.validTo.setMonth(this.voucher.validTo.getMonth() + 1);
                        break;
                    default:
                        (this.voucher.validFrom = new Date()), (this.voucher.validTo = new Date()), this.voucher.validTo.setFullYear(this.voucher.validTo.getFullYear() + 1);
                }
                this.voucher.validFrom.setHours(0, 0, 0, 0), this.voucher.validTo.setHours(0, 0, 0, 0);
            }),
            (t.prototype.copyVoucherUrl = function (e) {
                this.VoucherService.copyVoucherUrl(e);
            }),
...
!(function (e) {
    var t = (function () {
        function t(e, t, i, n) {
            (this.$http = e), (this.ToastService = t), (this.$window = i), (this.$location = n);
        }
        return (
            (t.$inject = ["$http", "ToastService", "$window", "$location"]),
            (t.prototype.filterVoucher = function (e) {
                return this.$http.get("api/v1/payment/filterVouchers", { params: e });
            }),
            ...
            (t.prototype.copyVoucherUrl = function (e) {
                ...
                try {
                    var n = this.$location.absUrl().substr(0, this.$location.absUrl().indexOf("#") + 1) + "/voucher/" + e.code;
                    i.val(n), t.append(i), i.select(), document.execCommand("copy") && this.ToastService.showInfo("Copied to clipboard.");
                } finally {
                    i.remove();
                }
            }),
